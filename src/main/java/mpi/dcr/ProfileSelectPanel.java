...
public class ProfileSelectPanel extends JPanel {
    ...
    private JList<Profile> allProfs;
    /** localization bundle */
    ...
    public List<Profile> getSelectedProfiles() {
        ...
        selectedProfs.addAll(allProfs.getSelectedValuesList());
