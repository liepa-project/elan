...
public class DCSmall {
    ...
    */
    ...
    /**
     * Compares two DCSmall instances by comparing their identifiers in 
     * case insensitive order.
     * <p>This is inconsistent with <em>equals</em> and separate comparators
     * should be considered when used in sorted sets or maps.
     * 
     * @param dc the other DCSmall object
     * @return whatever is returned by {@link String#CASE_INSENSITIVE_ORDER}'s 
     * compare method
     */
