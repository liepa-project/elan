...
/**
 * Class that turns a query into HTML.
 * 
 * @author klasal
 * @version 2007
 */
public class Query2HTML {
    ...
    /**
     * Translates whole Query into HTML, including HTML start- and end-tags
     * as well as css.
     *
    ...
    /**
     * Translates single constraint into HTML, including HTML start- and
     * end-tags as well as css.
     *
    ...
    /**
     * Appends recursively descendants of a constraint (not the constraint itself)
