...
public abstract class AbstractComplexSearchPanel
    ...
    /**
     * Sets the query
     * @param query the query to be set to queryPanel
     */
    ...
    /**
     * Resets the result viewer, hides the matchCounter and progressViewer
     * sets the current query number
     */
    ...
    /**
     * Sets current query number and gets the current query and sets it to the query panel.
     * If the query result status is modified then starts the search. 
     * else sets the same query result to the match counter and sets the status to the progress viewer 
     * @param nr the current queryNumber 
     */
    ...
    /**
     * Constructs the Elan search panel layout
     */
    ...
    /**
     * Abstract method to read the query
     */
    protected abstract void read();
    
    /**
     * Abstract method to save the query
     */
    ...
    private void createActions() {
        ...
        try {
            searchIcon = new ImageIcon(AbstractComplexSearchPanel.class.getResource("/toolbarButtonGraphics/media/Play16.gif"));
            stopIcon = new ImageIcon(AbstractComplexSearchPanel.class.getResource("/toolbarButtonGraphics/media/Stop16.gif"));
            newIcon = new ImageIcon(AbstractComplexSearchPanel.class.getResource("/toolbarButtonGraphics/general/New16.gif"));
            zoomIcon = new ImageIcon(AbstractComplexSearchPanel.class.getResource("/toolbarButtonGraphics/general/Zoom16.gif"));
            saveIcon = new ImageIcon(AbstractComplexSearchPanel.class.getResource("/toolbarButtonGraphics/general/SaveAs16.gif"));
            readIcon = new ImageIcon(AbstractComplexSearchPanel.class.getResource("/toolbarButtonGraphics/general/Open16.gif"));
            exportIcon = new ImageIcon(AbstractComplexSearchPanel.class.getResource("/toolbarButtonGraphics/general/Export16.gif"));
            backIcon = new ImageIcon(AbstractComplexSearchPanel.class.getResource("/toolbarButtonGraphics/navigation/Back16.gif"));
            forwardIcon = new ImageIcon(AbstractComplexSearchPanel.class.getResource("/toolbarButtonGraphics/navigation/Forward16.gif"));
        } catch (Exception e) {
            e.printStackTrace();
        }
