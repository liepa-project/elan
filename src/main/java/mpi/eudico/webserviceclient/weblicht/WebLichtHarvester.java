...
public class WebLichtHarvester {
	...
	final Logger LOG;
	/** a reload interval (one day) */
	public long cacheReloadInterval = 24 * 60 * 60 * 1000; // one day in milliseconds
	/** a cache file name */
	public static final String CACHE_FILENAME = "WebLichtServices.xml";
	private static final String NS_WC = "*";
	...
	public String harvestServicesRemote() throws IOException {
		...
		String urlString = "https://weblicht.sfs.uni-tuebingen.de/apps/harvester/resources/services";
	...
	public  List<WLServiceDescriptor> loadRelevantServicesFromCache(String cachePath) throws IOException {
		...
		try {
		    ...
		    LSInput lsInput = domImplementation.createLSInput();
		    lsInput.setEncoding("UTF-8");
			lsInput.setCharacterStream(reader = new InputStreamReader(new FileInputStream(cachePath), "UTF-8"));
