...
public class WebLichtWsClient {
	/** the WebLicht web service base URL */
	public static String baseUrl = "https://weblicht.sfs.uni-tuebingen.de/rws/";
	// hard coded url for converting plain text to tcf. There is an alternative one from BBAW
	private String convertUrl = "https://weblicht.sfs.uni-tuebingen.de/rws/service-converter/convert/qp";
