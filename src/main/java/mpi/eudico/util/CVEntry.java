 ...
 *
 */
public class CVEntry implements Comparable<CVEntry> {
    ...
    /** shortcut key variable */
    private int shortcutKeyCode = -1;
    /** preferred color */
    private Color prefColor;
    /** the vocabulary this entry is part of */
     ...
     * 
     * @param parent the vocabulary this entry is part of, the parent
     */
...
//    }
    ...
    /**
     * Returns the parent controlled vocabulary.
     * 
