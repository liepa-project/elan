...
public class BasicControlledVocabulary implements Iterable<CVEntry>, Cloneable {
    ...
    /** the definition URI of the default {@code undetermined} language */
    public static final String DEFAULT_LANGUAGE_DEF = "http://cdb.iso.org/lg/CDB-00130975-001";
    /** the language label of the default {@code undetermined} language */
     ...
     * (This implies that subclasses must override)<br>
     * {@code super.clone()} does not clone the CV entries.
     * 
...
//    }
    ...
    /**
     * An {@code Iterable<String>} to get at all entry values 
     * in the language at a specified index.
     */
    ...
    /**
     * An iterator for entry values of the language at a specified index.
     */
    ...
    /**
     * Sets the {@code init} state.
     * 
     * @param initMode if {@code true}, don't call handleModified
     */
...
//    }
    ...
    /**
     * Returns the default index of the default language.
     * 
	 * @return the default language index
	 */
	...
	/**
	 * Sets the index of the default language.
	 * 
	 * @param defaultLanguageIndex the index of the default language
	 */
...
//    }
    ...
    /**
     * Removes one entry from the map and puts another entry in the map.
     * 
    ...
    /**
     * Adds a language to the vocabulary.
     * 
     * @param li the language to add
     * @return the new number of languages or {@code -1} if the language could
     * not be added  
     */
    ...
    /**
     * Returns the {@code LangInfo} at the specified index.
     * 
     * @param index the language index (should be within bounds)
     * @return the language at that index or {@code null}
     */
    ...
    /**
     * Returns the (short) language id of the language at the specified index.
     * 
     * @param index the language index (should be within bounds)
    ...
    /**
     * Returns the (long) language label of the language at the specified index.
     * 
     * @param index the language index (should be within bounds)
