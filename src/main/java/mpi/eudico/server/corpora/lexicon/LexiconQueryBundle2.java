...
/**
 * Contains a Lexicon Link and a Lexical Field Identification for querying a
 * lexicon.
 * 
...
public class LexiconQueryBundle2 {
	...
	/**
	 * Creates an ew query bundle.
	 * 
	 * @param link the lexicon link
	 * @param lexicalEntryFieldIdentification the identifier of the lexicon
	 * entry field
	 */
	...
	/**
	 * Returns the entry field identifier.
	 * 
	 ...
	 * 
	 * @return the name of the lexicon link
	 */
	...
	/**
	 * Returns the lexicon link.
	 * 
	 * @return the lexicon link
	 */
	...
	public int hashCode() {
		...
		result = 31 * result + (fldId == null ? 0 : fldId.hashCode());
