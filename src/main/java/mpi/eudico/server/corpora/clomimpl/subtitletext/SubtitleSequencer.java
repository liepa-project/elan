 ...
 * of a text value and a beginning and end time, where the  end time can be either
...
public class SubtitleSequencer {
    ...
    public List<SubtitleUnit> createSequence(Transcription transcription, List<String> tierNames,
        ...
        ArrayList<SubtitleUnit> output = new ArrayList<>();
        ArrayList<SubtitleUnit> group = new ArrayList<>();
    ...
    public List<SubtitleUnit> createSequence(Transcription transcription, String[] tierNames,
        ...
        ArrayList<String> names = new ArrayList<>(Arrays.asList(tierNames));
