...
public class TierImpl implements Tier {
	...
	/**
	 * The transcription this tier is part of.
	 * <br>
	...
	/** the set of annotations of this tier */
	protected TreeSet<Annotation> annotations;
	/**
	 * some properties are stored in a map, see method for documentation
	 * */
	...
	/**
	 * Returns the annotation before the specified annotation (to the 'left').
	 * 
	...
	/**
	 * Returns the last annotation before the specified time.
	 * 
	...
	/**
	 * Returns the first annotation after the specified annotation (to the 
	 * 'right).
	 * 
	 * @param theAnnotation the query annotation
	...
	/**
	 * Returns the first annotation after the specified time.
	 * 
	 * @param time the query time value 
...
*/
	...
	/**
	 * Returns the begin and end time slot of the root annotation.
	 * 
...
*/	
	...
	private void forceChildAnnotationsOfAlignable(AlignableAnnotation aa) {
	    ...
	    if (tsChildren != null) {
	    	for (Map.Entry<Tier, ArrayList<AlignableAnnotation>> childEntry : tsChildren.entrySet()) {
	    		updateTSChildren(aa, (TierImpl) childEntry.getKey(), childEntry.getValue());
	    	}
	    }
	}
	 ...
	 * @param parAnn the parent annotation, should be an Included_In annotation or toplevel annotation
...
//						forceChildAnnotationsOfAlignable(depAA);
	...
	/**
	 * Sets the locale for this tier, used for input methods.
	 * 
	...
	/**
	 * Returns the first ancestor tier of type {@code Constraint#TIME_SUBDIVISION}
	 * traversing up starting with self.
	 * 
	 * Added by: AK 11/07/02
	...
	/**
	 * Returns the annotation at the specified time.
	 * 
...
*/
	...
	/**
	 * Returns a list of annotations overlapping the specified time interval.
	 * 
	...
	*/
	...
	/**
	 * Returns a list of annotations having the specified time slot as begin or
	 * end slot.
	 * 
	...
	/**
	 * Returns a list of annotations having the specified time slot as begin slot.
	 * 
	 * @param theSlot the time slot
	 * @return a list of all annotations (of this tier) that hold a reference to the specified
	...
	/**
	 * Returns a list of annotations having the specified time slot as end slot.
	 * 
	 * @param theSlot the time slot
	 * @return a list of all annotations (of this tier) that hold a reference to the specified
	...
	/**
	 * Returns whether this tier is time alignable, based on its type.
	 * 
	...
	/**
	 * A Getter based on the participant attribute.
	 */
	...
	/**
	 * A Getter based on the name of the linguistic type.
	 */
	public static class LinguisticTypeNameGetter implements ValueGetter {
		/** Creates a new getter instance */
		public LinguisticTypeNameGetter() {
			super();
		}
	...
	/**
	 * A Getter based on the content language attribute.
	 */
	...
	/**
	 * A Getter based on the name of the tier.
	 */
	...
	/**
	 * A Getter based on the name of the parent tier.
	 */
	public static class ParentTierNameGetter implements ValueGetter {
		/** Creates a new getter instance */
		public ParentTierNameGetter() {
			super();
		}
	...
	/**
	 * A Getter based on the locale attribute.
	 */
