...
//	}
	...
	/**
	 * Creates a new type file instance.
	 * 
	...
	/**
	 * Creates a new type file instance based on marker records.
	 * 
	 * @param markerRecords a list of marker records.
	 */
	...
	*/
	...
	/**
	 * Returns whether a specific marker or line contains IPA characters.
	 *  
...
//		System.out.println("isIPAtier("+name+") --> " + tiersWithIPA.contains(name));
	...
	/**
	 * Returns whether a specific marker is encoded in Unicode.
	 * @param name the name of the marker
	 * @return {@code true} if the marker is in Unicode, {@code false} 
	 * otherwise
	 */
...
//		System.out.println("isIPAtier("+name+") --> " + tiersWithIPA.contains(name));
	...
	/**
	 * Returns whether a marker will be excluded from import.
	 * 
	 * @param name the name of the marker
	 * @return {@code true} if it is excluded, {@code false} otherwise
	 */
    ...
    /**
     * Sets whether all markers will be considered to be Unicode.
     * 
     * @param allTiersUnicode if {@code true} all markers are to be handled
     * as Unicode.
     */
