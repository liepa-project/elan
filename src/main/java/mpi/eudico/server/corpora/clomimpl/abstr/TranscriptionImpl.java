...
public class TranscriptionImpl implements Transcription {
	...
	/**
	 * Constructor with the full source file path and an additional info object
	 * for the decoder/parser.
	 *
	...
	/**
	 * Constructor with file name and URL.
	 * 
	...
	/**
	 * Returns whether loading of this transcription has fully completed.
	 * 
	 * @return {@code true} if this transcription has been set as completely
	 * loaded, {@code false} until then
	 */
	...
	/**
	 * Sets whether the transcription has fully been loaded and initialized.
	 * 
	 * @param loaded if {@code true} the state is set to {@code loaded}
	 */
	...
	/**
	 * Adds a tier to this transcription.
	 * 
	 * @param theTier the tier to add
	 */
	...
	/**
	 * Remove a tier from this transcription.
	 * 
	 * @param theTier the tier to remove
	 */
	...
	/**
	 * Removes annotations that have been marked for deletion.
	 */
...
//	}
	...
	/**
	 * Returns a list of annotations that have the specified {@code TimeSlot}
	 * as their end time slot.
	 * 
	 * @param theSlot the slot to test
	...
	/**
	 * Gets all annotations and all time slots connected to the specified 
	 * starting time slot.
	 *   
	 * @param connectedAnnots the set to add connected annotation to
	 * @param connectedTimeSlots the set to add connected time slots to
	 * @param startingFromTimeSlot the time slot that is the starting point
	 */
	public void getConnectedAnnots(TreeSet<AbstractAnnotation> connectedAnnots, 
			TreeSet<TimeSlot/*Impl*/> connectedTimeSlots, TimeSlot/*Impl*/ startingFromTimeSlot) {
	...
	/**
	 * Returns whether each root tier in this transcription has a subdivision
	 * dependent tier.
	 * 
	 * @return {@code true} if each root tier has at least one subdivision type
	 * of dependent tier
	 */
...
//	}
	...
	/**
	 * Changed the implementation to return true only if the parameter is the same object. 
	 * 
	 * <p>For DOBES, equality is true if the names of two Transcriptions are the same.
	 *
	...
	public boolean equals(Object obj) {
        if (obj instanceof TranscriptionImpl transcription) {
        	return name != null && name.equals(transcription.getName()); 
        }
...
//	}
	...
	/**
	 * Returns a list of top level tiers, tiers without a parent tier.
	 *  
	 * @return a List of TierImpl objects without parent-tier
	 */
	...
	*/
	...
	/**
	 * Returns the {@code Property} with the specified name.
	 * 
	 * @param name the name or {@code key} of the property
	 * 
	 * @return the {@code Property} or {@code null}
	 */
	...
	/**
	 * Removes a lexicon service client factory from the collection of
	 * factories.
	 * 
	 ...
	 * goes with which {@code <TimeSlot, root tier>} combination.
	 */
	...
	/**
	 * Returns the list  of tiers which have the given participant name
	 * @param name the participant name
	 * @return the list of tiers
	 */
	@Override
	public List<TierImpl> getTiersWithParticipant(String name) {
		List<TierImpl> matchingTiers = new ArrayList<TierImpl>();
		
		for (TierImpl tier : tiers) {
			
			if (tier.getParticipant() != null && tier.getParticipant().equals(name)) {
				matchingTiers.add(tier);
			}
