...
//    private static Logger logger = Logger.getLogger(ShoeboxArray.class.getName());
    ...
    /** special EUDICO participant label, customizable when a marker file is used */
    static String label_eudicoparticipant = "\\EUDICOp";
    /** constant for special EUDICO start time label */
    public static final String label_eudicot0 = "\\EUDICOt0";
    /** constant for special EUDICO end time label */
...
//        logger.log(Level.FINE, "reading START");
 ...
 //       logger.log(Level.FINE, "reading STOP");
    ...
    /////////////////
    /**
     * Returns the Shoebox header line.
     * 
     * @return the Shoebox header
     */
...
//        logger.log(Level.FINE, " --- getCell == '" + result + "'");
     ...
     * @return the contetns of that cell
     */
...
//        logger.log(Level.FINE, " --- getCell(" + label + ", " + block);
    ...
    /**
     * Returns the speaker of a block.
     * 
    ...
    /**
     * Returns media descriptors, if any.
     * 
	...
	/**
	 * Returns the number of labels or tiers.
	 * 
    ...
    /**
     * Returns the label node at the specified index.
     * 
     * @param i the index
     * @return a label tree node
     */
    ...
    /**
     * Returns the label node with the specified name.
     * 
    ...
    /**
     * Returns the number of blocks or records.
     * 
    ...
    /**
     * Returns the contents of the Shoebox array.
     * 
    ...
    /**
     * Writes the contents to System.out.
     * 
     * @throws Exception any exception
     */
    ...
    /**
     * Dumps the array, should look like sbx.
     *
     * @throws Exception any exception
     */
...
//        }
    ...
    /**
     * Returns the root marker for a specific block.
     * 
