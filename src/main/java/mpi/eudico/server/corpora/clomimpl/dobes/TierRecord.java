...
public class TierRecord {
	...
	/**
	 * Returns the external reference id reference.
	 * 
	 * @return the external reference id reference
	 */
	...
	/**
	 * Sets the external reference id reference.
	 * 
	 * @param value the external reference id reference
	 */
	...
	/**
	 * Returns the content language reference.
	 *  
	 * @return the content language reference
	 */
	...
	/**
	 * Sets the content language reference.
	 * 
	 * @param value the content language reference
	 */
