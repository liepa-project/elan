...
public class PraatTextGridEncoder implements AnnotationDocEncoder, ServerLogger {
    ...
    private static final String tx = "text = ";
	...
	public void encodeAndSave(Transcription theTranscription,
        ...
        // test the encoding argument, reverting to the platform default in case of null or unsupported encoding
        if (encoding == null || encoding.toLowerCase().equals("default")) {
        	...
        	try {
        		...
        		if (LOG.isLoggable(Level.WARNING)) {
        			LOG.log(Level.WARNING, "The specified encoding (\"%s\") is not supported, using the platform default encoding".formatted(encoding));
        		}
        		encoding = Charset.defaultCharset().name();
        	}
        }
