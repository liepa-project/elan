...
public class CsvIdenticalSampleSequenceMerger {
	 ...
	 * 
	 * @param inputFilePath the path to the input file
	 * @param columnsToProcess a list of column names to process
	 */
	...
	/**
	 * Returns the milliseconds per sample value.
	 * 
	 * @return the milliseconds per sample
	 */
	...
	/**
	 * Sets the milliseconds per sample value.
	 * 
	 * @param msPerSample the new milliseconds per sample value
	 */
