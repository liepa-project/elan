...
public class EAF26Encoder implements AnnotationDocEncoder {
    ...
    public static Element createDOM(Transcription theTranscription,
        ...
        Iterator<MediaDescriptor> mdIter = attisTr.getMediaDescriptors().iterator();
        ...
        Iterator<LinkedFileDescriptor> lfdIt = attisTr.getLinkedFileDescriptors().iterator();

        while (lfdIt.hasNext()) {
        	LinkedFileDescriptor lfd = lfdIt.next();
        ...
        // creation order
        Vector<TierImpl> storeOrder = new Vector<>(attisTr.getTiers());
        /*
		...
		*/
        ...
        Iterator<TierImpl> tierIter = storeOrder.iterator();
...
//            }
        ...
        Iterator<TierImpl> tierIter2 = storeOrder.iterator();
