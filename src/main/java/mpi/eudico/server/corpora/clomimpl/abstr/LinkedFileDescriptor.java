...
public class LinkedFileDescriptor implements Cloneable {
	...
	public Object clone() {
        try {
            ...
            if (linkURL != null) {
                cloneLFD.linkURL = linkURL;
            }
            
            if (relativeLinkURL != null) {
            	cloneLFD.relativeLinkURL = relativeLinkURL;
            }
            
            if (mimeType != null) {
                cloneLFD.mimeType = mimeType;
            }

            if (associatedWith != null) {
                cloneLFD.associatedWith = associatedWith;
            }

            if (configFile != null) {
                cloneLFD.configFile = configFile;
            }
