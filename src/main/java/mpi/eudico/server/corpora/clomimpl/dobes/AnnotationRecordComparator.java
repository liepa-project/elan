 ...
 * @author Han Sloetjes
 */
public class AnnotationRecordComparator implements Comparator<AnnotationRecord>, Serializable {
	private static final long serialVersionUID = 8588751662788923655L;
