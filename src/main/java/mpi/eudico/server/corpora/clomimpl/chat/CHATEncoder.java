...
public class CHATEncoder implements AnnotationDocEncoder {
	...
	private static final String LANGUAGE_LABEL = "@Languages:\t";
	private static final String PARTICIPANTS_LABEL = "@Participants:\t";
	private static final String ID_LABEL = "@ID:\t";
	private static final String SOUND_LABEL = "%snd:";
	private static final String VIDEO_LABEL = "%mov:";
	private static final String LANG_LABEL = "%lan:";
	...
	private void writeHeader(Transcription theTranscription, EncoderInfo encoderInfo, OutputStreamWriter out) {
		...
		try {
			...
			if (!participantsString.equals(PARTICIPANTS_LABEL)) {
			...
			String idTemplate = ID_LABEL + "%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|";
