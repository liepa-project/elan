...
public class ToolboxEncoderInfo implements EncoderInfo {
    ...
    /**
     * Returns whether a media marker is included in the export.
     * 
	...
	/**
	 * Sets whether a media marker should be included in the export.
	 * 
	 * @param includeMediaMarker if {@code true} a media marker will be 
	 * exported
	 */
	...
	/**
	 * Returns the media field marker.
	 * 
	 * @return the media marker
	 */
	 ...
	 * 
	 * @return the media file name or {@code null}
	 */
	...
	/**
	 * Sets the media file name to be exported in the media field marker.
	 * 
