...
public class EAF27Encoder implements AnnotationDocEncoder {
	...
	public void encodeAndSave(Transcription theTranscription,
        ...
        if (documentElement != null) {
        	...
        	if (LOG.isLoggable(Level.WARNING)) {
        		LOG.log(Level.WARNING, "Cannot save the transcription, it is null");
        	}
        }
    }
    ...
    public void encodeAsTemplateAndSave(Transcription theTranscription,
        ...
        if (documentElement != null) {
        	...
        	if (LOG.isLoggable(Level.WARNING)) {
        		LOG.log(Level.WARNING, "Cannot save as template, the transcription is null");
        	}
        }
    }
    ...
    public static Element createDOM(Transcription theTranscription, List<TierImpl> tierOrder, String path) {
        ...
        if (attisTr == null) {
        	if (LOG.isLoggable(Level.WARNING)) {
        		LOG.log(Level.WARNING, "Cannot create DOM, theTranscription is null");
        	}
            return null;
        }
        ...
        try {
            ...
            //ex.printStackTrace();
        	if (LOG.isLoggable(Level.WARNING)) {
        		LOG.log(Level.WARNING, "Cannot create document factory EAF27: " + ex.getMessage());
        	}
            return null;
        }
		...
		*/
        ...
        for (Map.Entry<String, LexiconLink> lexLinkEntry : lexiconLinks.entrySet()) {
        	...
        	if(!savedLexiconLinks.containsKey(linkName)) {
        		Element lexSrvcElement = eafFactory.newLexiconLink("lr" + lexRefIndex++, lexLinkEntry.getValue());
        		annotDocument.appendChild(lexSrvcElement);
        	}
        }
    ...
    public static Element createTemplateDOM(Transcription theTranscription,
        ...
        try {
            ...
            //ex.printStackTrace();
        	if (LOG.isLoggable(Level.WARNING)) {
        		LOG.log(Level.WARNING, "Cannot create document factory EAF26: " + ex.getMessage());
        	}
            return null;
        }
