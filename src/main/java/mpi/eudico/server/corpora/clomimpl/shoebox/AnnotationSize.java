...
public class AnnotationSize implements ACMEditListener {
    ...
    /**
     * Creates a layout in pixels, a list of {@code AnnotationSizeContainer}'s
     * for the specified tier and the specified font metrics.
     *  
     * @param tier the tier to process
     * @param fontmetrics the font and other layout related metrics
     * @return the tier layout
     */
    ...
    /**
     * Returns a list of {@code TierImpl} objects.
     * 
    ...
    /**
     * Creates a list of tiers part of one block or hierarchy.
     */
