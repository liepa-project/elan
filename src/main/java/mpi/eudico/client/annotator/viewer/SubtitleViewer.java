...
//    			}
    ...
    /**
     * Indirectly called by the {@code inline edit box} when it is committed or
     * cancelled. The subtitle scrollpane is then added to the layout again.
     * 
     *  @see #editingCommitted()
     *  @see #editingCancelled()
     */
    private void putOriginalComponentBack() {
        inlineEditBox = null;
        removeAll();
        add(jspSubtitle, BorderLayout.CENTER);
        validate();
