...
public class SignalPlayerView extends TimeScaleBasedViewer
    ...
    /** default number of pixels for drag-scrolling */
	...
	*/
    ...
    private boolean loadData(long fromTime, long toTime, final int width) {
        ...
        double firstSeeksample = from * samp.getSampleFrequency() / 1000d;
    ...
    private void drawCuePoints(Graphics2D big2g) {
    	// change this test again when/once other WAVSamplesProviders are supported
