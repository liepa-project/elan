...
public class LexiconQueryBundleDialog extends ClosableDialog implements
	...
	private JComboBox<String> lexiconLinkComboBox;
	...
	/**
	 * Creates a new bundle dialog instance.
	 * 
	 ...
	 * @param modal whether the dialog is modal
	 * @param trans the transcription
	 * @param queryBundle the query bundle to edit
	 */
	public LexiconQueryBundleDialog(Dialog dialog, boolean modal, Transcription trans,
	...
	private void initComponents() {
		...
		lexiconLinkComboBox = new JComboBox<String>();
	 ...
	 * 
	 * @return {@code true} if the dialog was canceled or closed without action
	 */
	...
	private static class LexiconEntryTableModel extends AbstractTableModel {
