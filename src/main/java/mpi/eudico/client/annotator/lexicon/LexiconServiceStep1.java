...
public class LexiconServiceStep1 extends StepPane implements ActionListener, ItemListener, KeyListener {
	...
	private JComboBox<String> lexiconTypeList;
	...
	protected void initComponents() {
		...
		if (lexiconServiceClientFactories != null) {
			lexiconTypeList = new JComboBox<String>(lexiconServiceClientFactories.keySet().toArray(new String[0]));
		} else {
			lexiconTypeList = new JComboBox<String>(new String[]{});
		}
