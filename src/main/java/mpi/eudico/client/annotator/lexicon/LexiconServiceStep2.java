...
public class LexiconServiceStep2 extends StepPane implements ListSelectionListener {
	...
	private JList<LexiconIdentification> lexiconList;
	private JScrollPane lexiconListScroller;
	private DefaultListModel<LexiconIdentification> lexiconListModel;
	...
	protected void initComponents() {
		...
		lexiconListModel = new DefaultListModel<LexiconIdentification>();
		lexiconList = new JList<LexiconIdentification>(lexiconListModel);
	    ...
	    if(lexica instanceof ArrayList<?>) {
	    	for(Object lexicon: (ArrayList<?>) lexica) {
	    		if(lexicon instanceof LexiconIdentification) {
	    			lexiconListModel.addElement((LexiconIdentification) lexicon);
	    		}
	    	}
	    }
	}
