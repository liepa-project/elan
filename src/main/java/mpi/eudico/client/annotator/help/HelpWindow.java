...
public class HelpWindow {
     ...
     *
     * @throws HelpException if the helpfiles can not be found or the helpset can not be read, or the JavaHelp libraries
     *     could not be loaded
     */
    public static Window getHelpWindow() throws
                                         HelpException {
        if (helpWindow == null) {
            try {
                URL url = null;
                url = HelpWindow.class.getResource("/jhelpset.hs");
                ...
                if (helpWindow == null) {
                    ...
                    try {
                        ImageIcon icon =
                            new ImageIcon(HelpWindow.class.getResource("/mpi/eudico/client/annotator/resources/ELAN16.png"));
