...
public class PlayerFactory {
    ...
    static final String[] MMF_EXTENSIONS = new String[]{"asf", "wma", "wmv", "m4a", "m4v", "mp4"};
    ...
    /** constant for FFmpeg as a framework for audio extraction from video */
    public static final String FFMPEG = "FFmpeg";
    /** constant indicating no audio extraction from video */
