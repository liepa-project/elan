...
public class AnnotationSlicer {
	...
	/**
	 * Returns a map containing time intervals as keys and lists of annotations
	 * as values. Each list of annotations is of the same size as the list of
	 * tiers, containing <code>null</code> values for the tiers where there is
	 * no annotation in that interval.
	 * 
