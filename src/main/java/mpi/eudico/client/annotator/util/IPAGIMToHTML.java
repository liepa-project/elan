...
/**
 * Class to create a simple {@code HTML} page of the extended {@code IPA} 
 * {@code .gim} ({@code GATE Input Method} file. Could probably be generalized
 * to convert any {@code .gim} file.
 */
public class IPAGIMToHTML {
	...
	/**
	 * Starts the conversion with default path and name settings.
	 * 
	 * @param args ignored
	 */
