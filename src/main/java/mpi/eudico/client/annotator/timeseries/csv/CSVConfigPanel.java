...
public class CSVConfigPanel extends TSConfigPanel implements ActionListener,
    ...
    private JComboBox<String> currentTracksCB;
    ...
    private void initComponents() {
        ...
        currentTracksCB = new JComboBox<String>();
    ...
    private void updateForTrack(String trackName) {
        ...
        if (currentTrack != null) {
            ...
            if (!Objects.equals(currentTracksCB.getSelectedItem(), currentTrack.getTrackName())) {
    ...
    /**
     * Performs checks, creates a track(configuration) and adds it to the source
    ...
    private void doDelete() {
        if (currentTrack != null) {
            ...
            if (currentTracksCB.getItemCount() > 0) {
                updateForTrack(currentTracksCB.getItemAt(0));
            } else {
                updateForTrack(null);
            }
        }
