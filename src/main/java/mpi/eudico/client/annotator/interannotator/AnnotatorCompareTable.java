...
/**
 * A class that creates a table model based on the overlaps of annotations on two tiers. The required amount of overlap can
 * be set to a ratio between 0.5 and 1.0.
 */
public class AnnotatorCompareTable {
    private float defOverlapThreshold = 0.60f;
    // no corresponding segment
    private static final String NCS = "n.c.s.";
    ...
    /**
     * Returns the overlap (logical AND) of 2 segments, i.e. smallest end time - largest begin time.
     *
    ...
    /**
     * Returns the total extent (logical OR) of 2 segments, i.e. largest end time - smallest begin time.
     *
     * @param bt1 first begin time
     * @param et1 first end time
     * @param bt2 second begin time
