...
/**
 * A two dimensional table of integer values with one set of labels for both the column and the row headers. This class
 * provides methods for incrementing cell values and for adding a specific number to the value of a cell.
 */
public class AgreementTable {
    ...
    /**
     * Initializes a two dimensional int array with the number of rows and columns equal to the number of labels in the label
     * list. After creation the list and the sizes of the table are assumed to be immutable.
     *
     * @param idLabel an identifier for the table, can be used for the score value in case of a 2 x 2 yes/no agreement
     *     table
    ...
    /**
     * Following approaches by several others in their algorithms the values in the table are multiplied by two, with
     * exception of the values in the unmatched values row and column. One advantage is that the total sum of the cells in
     * the table equals the number of annotations involved.
     */
