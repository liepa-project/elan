...
public class MultipleFileFlexExportStep5 extends AbstractMultiFileExportProgessStepPane {
    ...
    /**
     * Extracts the type information from the tier type name. Expected type name format: <TierTypeName-FLExTypeName-language>
     * Since both the FLEx type name and the language part can contain the hyphen character ('-'), the first check is now if
     * the input ends with any of the available content languages in the transcription.
     *
     ...
     * <TierTypeName-FLExTypeName-language> Since both the FLEx type name and the language part can contain the hyphen
     * character ('-'), the first check is now if the input ends with any of the available content languages in the
     * transcription.
     *
