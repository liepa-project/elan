...
public class ExportFilmStripDialog extends ClosableDialog implements ActionListener,
                                                                     ProgressListener {
     ...
     */
    public ExportFilmStripDialog(Frame parent, ElanMediaPlayer[] players, String waveFile, Selection selection) throws
                                                                                                                HeadlessException {
        super(parent, true);
     ...
     * @throws IllegalArgumentException if there is no selection
     */
    public ExportFilmStripDialog(ElanMediaPlayer[] players, String waveFile, Selection selection) throws
                                                                                                  HeadlessException {
    ...
    private void initComponents() {
        ...
        everyRB = new JRadioButton(ElanLocale.getString("ExportFilmStrip.EveryFrame"));
        everyRB.setSelected(true);
        skipRB = new JRadioButton(ElanLocale.getString("ExportFilmStrip.EveryNthFrame"));
        ...
        includeFrameTC = new JCheckBox(ElanLocale.getString("ExportFilmStrip.IncludeTimeCode"));
        ...
        includeWavCB = new JCheckBox(ElanLocale.getString("ExportFilmStrip.Waveform.Include"));
        includeWavCB.setSelected(true);
        includeWavCB.addActionListener(this);
        wavHeightLb = new JLabel(ElanLocale.getString("ExportFilmStrip.Waveform.Height"));
        heightSpinner = new JSpinner(new SpinnerNumberModel(DEF_WIDTH, 20, 400, 5));
        heightSpinner.setPreferredSize(spinDim);
        rulerVisCB = new JCheckBox(ElanLocale.getString("TimeScaleBasedViewer.TimeRuler.Visible"));
        stereoLb = new JLabel(ElanLocale.getString("SignalViewer.Stereo"));
        separateRB = new JRadioButton(ElanLocale.getString("SignalViewer.Stereo.Separate"));
        separateRB.setSelected(true);
        mergedRB = new JRadioButton(ElanLocale.getString("SignalViewer.Stereo.Merged"));
        blendedRB = new JRadioButton(ElanLocale.getString("SignalViewer.Stereo.Blended"));
    ...
    private void startExport() {
        ...
        exporter = new ExportFilmStrip(players, waveFile, vidWidth, framesStep, includeWav, wavHeight);
        ...
        exporter.createImageInThread(selection.getBeginTime(), selection.getEndTime());
    }
