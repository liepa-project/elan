...
public class MultipleFileThemeExportStep2 extends AbstractMultiFileExportSaveSettingsStepPane {
    ...
    protected void initOtherOptionsPanel() {
        ...
        useCVForVvtCB = new JCheckBox(ElanLocale.getString("MultiFileExportTheme.Label.UseCV"), false);
        useTierNameAsActorCB = new JCheckBox(ElanLocale.getString("MultiFileExportTheme.Label.TierAsActor"), true);
