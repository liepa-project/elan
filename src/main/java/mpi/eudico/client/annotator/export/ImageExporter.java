...
public class ImageExporter {
    ...
    /**
     * Shows a save dialog with .jpg, .bmp and .png as file filters and  writes the image to file.
     *
     ...
     *
     * @param image the image to save
     * @param mediaFilePath the name or path of the video file in case the image was extracted from a video, can be null
    ...
    public void exportImage(Image image, String mediaFilePath, Long mediaTime) {
        ...
        if (img == null) {
            JOptionPane.showMessageDialog(parentFrame,
                                          ElanLocale.getString("ExportImage.Message.NoImage"),
        ...
        if (mediaFilePath != null) {
            ...
            if (mediaFileName != null && mediaTime != null) {
                mediaFileName = mediaFileName + "_" + mediaTime;
            }
        }
