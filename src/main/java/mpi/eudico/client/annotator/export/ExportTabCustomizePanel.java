...
public class ExportTabCustomizePanel extends JPanel {
    ...
    /**
     * Creates a new ExportTabCustomizePanel instance based on the specified column names and the specified selected state
     * flags. The 2 arrays should be of the same length.
     *
    ...
    /**
     * Creates a new ExportTabCustomizePanel instance based on the specified column names, setting all columns deselected.
     *
     * @param headers the column header values
     */
    ...
    /**
     * Creates a new ExportTabCustomizePanel instance based on the specified column names, setting the columns at the
     * specified indices selected.
     *
     * @param headers the column header values
    ...
    public String[] getColumnOrder() {
        if (table.getTableHeader() != null) {
            Enumeration<TableColumn> colEnum = table.getTableHeader().getColumnModel().getColumns();
            List<String> colNames = new ArrayList<String>(table.getTableHeader().getColumnModel().getColumnCount());
