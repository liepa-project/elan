...
public class ExportSmilDialog extends AbstractExtTierExportDialog implements ChangeListener {
    ...
    protected void extractTiers() {
        ...
        if (stringPref != null) {
            ...
            if (!BY_TIER.equals(stringPref)) {
                ...
                setSelectedItems(Preferences.getListOfString("ExportSmilDialog.LastSelectedItems", transcription));
            }
        }
    }
    ...
    protected boolean startExport() throws
        ...
        File exportFile =
            promptForFile(ElanLocale.getString("Export.TigerDialog.title"), null, FileExtension.SMIL_EXT, false);
        ...
        try {
            if (selection != null && restrictCheckBox.isSelected()) {
                EAF2SMIL.export2SMIL(transcription,
                                     exportFile,
                                     tierNames,
                                     mediaURL,
                ...
                EAF2SMIL.export2SMIL(new File(transcription.getPathName()),
                                     exportFile,
                                     tierNames,
                                     mediaURL,
                                     offset,
