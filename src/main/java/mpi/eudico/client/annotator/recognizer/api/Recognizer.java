...
//	public static final int EXAMPLE_SEGMENTS_NOT_SUPPORTED = 2;
	/** constant for the audio type of recognizer */
	public static final int AUDIO_TYPE = 0;
	/** constant for the video type of recognizer */
	public static final int VIDEO_TYPE = 1;
	/** constant for any other type of recognizer */
	public static final int OTHER_TYPE = 2;
	/** constant for the number of recognizer types */
...
/**
	 ...
	 */
	public default boolean setMedia(List<String> mediaFilePaths) {
		return false;
	}
	 ...
	 */
	public default JPanel getControlPanel() {
		return null;
	}
...
//	public String getReport();
	 ...
	 */
	public default void updateLocale(Locale locale) {
	 ...
	 */
	public default void updateLocaleBundle(ResourceBundle bundle) {
