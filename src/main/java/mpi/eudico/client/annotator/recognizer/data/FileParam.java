 ...
 * @author Han Sloetjes
 */
public class FileParam extends Param implements Cloneable {
	 ...
	 */
	@Override
	public FileParam clone() throws CloneNotSupportedException {
		FileParam clonePar = (FileParam) super.clone();
		if (mimeTypes != null) {
