...
/**
 * Final step of the import {@code Praat TextGrid} process. Parsing of the file and creation of new tiers and annotations.
 */
@SuppressWarnings("serial")
public class ImportPraatTGStep3 extends StepPane implements ProgressListener {
    private final Transcription curTranscription;
     ...
     */
    public ImportPraatTGStep3(MultiStepPane multiPane, Transcription curTranscription) {
        super(multiPane);
     ...
     * @param multiPane the parent pane
     * @param curTranscription the transcription
     * @param inNewTranscription if {@code true} a new transcription will be created for the imported tiers and
     *     annotations
     */
    public ImportPraatTGStep3(MultiStepPane multiPane, Transcription curTranscription, boolean inNewTranscription) {
        super(multiPane);
        this.curTranscription = curTranscription;
    ...
    public boolean doFinish() {
        ...
        final Boolean autoDetectWav = (Boolean) multiPane.getStepProperty("AutoDetectWav");
                    ...
                    public void run() {
                        try {
                            ...
                            com.execute(curTranscription,
                                        new Object[] {ptg, typeName, skipEmpty, autoDetectWav, inNewTranscription});
