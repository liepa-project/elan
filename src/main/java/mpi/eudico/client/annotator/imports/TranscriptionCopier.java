...
public class TranscriptionCopier {
    ...
    /**
     * Copies the contents of one transcription to another.<br> Note: there may be quite a bit of overlap with classes that
     * copy a tier etc.
     *
    ...
    /**
     * Copies information stored in the header of an .eaf Currently only the author field is copied.
     *
     * @param src the source transcription
     * @param dest the destination transcription
     *
