...
/**
 * Second step in the merge process; loading of first source (=dest transcription) or copying of first transcription, loading
 * of second source, presentation of  available tiers for selection, etc.
 */
@SuppressWarnings("serial")
public class MergeStep2 extends StepPane implements ProgressListener,
                                                    ActionListener {
    ...
    /**
     * A JTree of DefaultMutableTreeNodes. Its userObjects are {@code SelectableObject<String>}, with object = String (a Tier
     * name).
     */
    ...
    public void initComponents() {
        ...
        firstLabel = new JLabel(ElanLocale.getString("MergeTranscriptionDialog.Label.TiersSource1"));
        secLabel = new JLabel(ElanLocale.getString("MergeTranscriptionDialog.Label.SelectTiers"));
        overwriteCB = new JCheckBox(ElanLocale.getString("MergeTranscriptionDialog.Label.Overwrite"));
        copyTiersCB = new JCheckBox(ElanLocale.getString("MergeTranscriptionDialog.Label.CopyAndRenameTiers"));
    ...
    /**
     * Fills the tree overview of both transcriptions. The second tree has checkboxes to represent the selected state of each
     * tier.
     */
    ...
    public void enterStepForward() {
        if ((firstSource != null) && (secondSource != null) && (destFileName != null)) {
    ...
    /**
     * Store selected tiers, check the overwrite checkbox, create a command, register as listener and activate the progress
     * ui.
     *
    ...
    public boolean doFinish() {
        ...
        DefaultMutableTreeNode root = (DefaultMutableTreeNode) secTree.getModel().getRoot();
        ...
        if (appendAnnsWithMedia) {
            long mediaDur = ELANCommandFactory.getViewerManager(firstTrans).getMasterMediaPlayer().getMediaDuration();
        ...
        Object[] args = new Object[] {secTrans,
                                      destFileName,
                                      tiersToAdd,
                                      Boolean.valueOf(overwrite),
                                      Boolean.valueOf(addLinkedFiles),
                                      Boolean.valueOf(copyInsteadOfMerge)};
    ...
    /**
     * @see mpi.eudico.client.annotator.util.ProgressListener#progressUpdated(java.lang.Object, int, java.lang.String)
     */
    @Override
    ...
    /**
     * @see mpi.eudico.client.annotator.util.ProgressListener#progressCompleted(java.lang.Object, java.lang.String)
     */
    @Override
        ...
        if (progressPanel.isVisible()) {
            ...
            if (com != null) { // merge process complete
                ...
                int option = JOptionPane.showOptionDialog(this,
                                                          (message + "\nOpen new transcription in ELAN?"),
                                                          null,
                                                          JOptionPane.YES_NO_OPTION,
                                                          JOptionPane.INFORMATION_MESSAGE,
                                                          null,
                                                          new Object[] {ElanLocale.getString("Button.Yes"),
    ...
    /**
     * @see mpi.eudico.client.annotator.util.ProgressListener#progressInterrupted(java.lang.Object, java.lang.String)
     */
    @Override
        ...
        if (e.getSource() == allButton) {
            ...
            while (en2.hasMoreElements()) {
                ...
                if (node2 != transNode2) {
                    ...
                    node2.setUserObject(new SelectableObject<String>(leftSide.getValue(), wasSelected));
                }
            }
    ...
    /**
     * Checks whether tiers should be selected or deselected based on dependencies  and available tiers in the destination
     * after a change in the selected state  of a tier.
     *
                ...
                if (so.isSelected()) {
                    ...
                    if (t2 == null) {
                        if ((destTrans.getTierWithId(t1.getParentTier().getName()) == null)
                            || !lingTypeCompatible(destTrans.getTierWithId(t1.getParentTier().getName()),
                                                   t1.getParentTier())) {
     ...
     *
     * @param select if true all nodes in the second tree will be set selected, otherwise they will be deselected.
     */
    @SuppressWarnings("unchecked")
    ...
    class LoadThread extends Thread {
        ...
        public void run() {
            try {
                ...
                progressInterrupted(this, "An error occurred: " + ex.getMessage());
            }
        }
    }
}
