...
/**
 * Second step in import {@code Praat TextGrid} process: select a (root) linguistic type.
 */
@SuppressWarnings("serial")
public class ImportPraatTGStep2 extends StepPane implements ListSelectionListener {
    private final TranscriptionImpl curTranscription;
    ...
    private void extractTypes() {
        ...
        if (rootTypes.size() == 0) {
            ...
            Command com = ELANCommandFactory.createCommand(curTranscription, ELANCommandFactory.ADD_TYPE);
            com.execute(curTranscription, new Object[] {"default-lt", null, null, Boolean.TRUE, Boolean.FALSE});
    ...
    public void initComponents() {
        ...
        columns = new String[] {LinguisticTypeTableModel.NAME,
