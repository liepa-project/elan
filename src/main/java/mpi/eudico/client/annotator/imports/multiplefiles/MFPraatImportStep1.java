...
/**
 * First step pane for initializing and selecting multiple files
 */
...
public class MFPraatImportStep1 extends AbstractMFImportStep1 {
    ...
    protected void initComponents() {
        ...
        encodings = new String[] {ElanLocale.getString("Button.Default"), FileChooser.UTF_8, FileChooser.UTF_16};
