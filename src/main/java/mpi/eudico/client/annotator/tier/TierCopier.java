...
public class TierCopier {
    ...
    /** transition from root tier to included in tier */
    public static final int ROOT_TO_INCLUDED_IN = 11;
    
    /** transition from time subdivision tier to included in tier */
    public static final int TIMESUB_TO_INCLUDED_IN = 12;
    
    /** transition from symbolic subdivision tier to included in tier */
    public static final int SYMSUB_TO_INCLUDED_IN = 13;
    
    /** transition from symbolic association tier to included in tier */
    public static final int ASSOC_TO_INCLUDED_IN = 14;
    
    /** transition from included in tier to time subdivision tier */
    public static final int INCLUDED_IN_TO_TIMESUB = 15;
    
    /** transition from included in tier to symbolic subdivision tier */
    public static final int INCLUDED_IN_TO_SYMSUB = 16;
    
    /** transition from included in tier to symbolic association tier  */
