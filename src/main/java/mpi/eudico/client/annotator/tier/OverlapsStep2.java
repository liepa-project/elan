...
public class OverlapsStep2 extends StepPane{
    ...
    /**
     * Updates the state of {@code next} and {@code previous} buttons.
     */
	...
	private class ConstraintDialog extends ClosableDialog implements ActionListener, ItemListener{
		...
		private JComboBox<String> tierNameCB;
		...
		private void initConstraintPanel(List<String[]> initConstraintValues){
			...
			tierNameCB = new JComboBox<String>();
		...
		public void actionPerformed(ActionEvent e) {
			...
			if( btn == addButton ){
				...
				String[] value = new String[]{"", tierNameCB.getItemAt(selectedIndex), ElanLocale.getString("OverlapsDialog.Combo.Contains"), annotationValueTF.getText()};
