...
public class AnnotationFromOverlaps implements ProcessReporter {
    ...
    /** destination tier created or not identifier */
    ...
    /** list containing array of tier value constraints */
