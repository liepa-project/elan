...
public abstract class AbstractDestTierAndTypeSpecStepPane extends StepPane implements ListSelectionListener, ActionListener, KeyListener {
	...
	/** list of new root types */
	protected List<String> newRootTypeList;	
	
	/** list of new child types */
...
//		destinationTierConfigurationPanel.add(parentTierCB, gbc);
	...
	private class LinguisticTypeTableModel extends AbstractTableModel{
		...
		public LinguisticTypeTableModel(){
			...
			columnNames[0] = ElanLocale.getString("DestTierAndType.Column.LinguisticType");
			columnNames[1] = ElanLocale.getString("DestTierAndType.Column.Stereotype");			
