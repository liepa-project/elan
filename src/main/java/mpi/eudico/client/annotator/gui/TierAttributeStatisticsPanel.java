...
/**
 * Calculates and shows statistics per transcription, statistics based on a specific attribute of a tier. Replaces the
 * separate panels for participant, annotator, linguistic type and content language.
 *
 * @author Mark Blokpoel, Han Sloetjes
 * @version 1.0 Dec. 2014 Generalization of statistics based on a specific attribute of tiers (type, participant, annotator,
 *     language)
 */
...
public class TierAttributeStatisticsPanel extends AbstractStatisticsPanel {
    ...
    /**
     * the localization key for the attribute's table header
     */
     ...
     */
    public TierAttributeStatisticsPanel(TranscriptionImpl transcription, long duration, String attributeHeaderString,
    ...
    /**
     * This method initializes the table and fills is with statistics. The number of columns currently is 10; if this changes
     * extending classes need to be updated.
     */
    protected void initTable() {
        if (transcription != null) {
            ...
            String[] headers = {ElanLocale.getString(attributeHeaderString), //0 the attribute
     ...
     *
     * @param numRows The number of rows in the table, usually equal to the number of the specific attribute in the file
        ...
        for (String curAttr : tierAttribute) {
            ...
            if (nrAnnotations == 0) {
                ...
                if (totalDuration == 0) {
                    ...
                    data[y][8] = format2.format(timeAnnotated / (float) (totalDuration * tiersWithCurAttr.size())
                                                * 100); /* TotalDurationPercentage */
                }
