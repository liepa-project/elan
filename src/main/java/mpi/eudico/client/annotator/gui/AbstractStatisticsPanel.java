...
public abstract class AbstractStatisticsPanel extends JPanel {
     ...
     */
    protected DecimalFormat format = new DecimalFormat("#0.0#####", new DecimalFormatSymbols(Locale.US));

    /**
     * formatter for ss.ms values
     */
    protected DecimalFormat format2 = new DecimalFormat("#0.0##", new DecimalFormatSymbols(Locale.US));
     ...
     */
    public AbstractStatisticsPanel(TranscriptionImpl transcription, long totalDuration) {
        super();
        this.transcription = transcription;
