...
public class FilesTierSortAndSelectPanel extends AbstractTierSortAndSelectPanel implements ActionListener,
    ...
    /**
     * Constructor for initializing the panel with a preferred tier order and a list of selected tiers.
     *
     * @param files the list of files to extract the tiers from
    ...
    /**
     * Constructor for initializing the panel with a preferred tier order, a list of selected tiers and a flag to indicate
     * whether or not reordering should be allowed.
     *
     * @param files the list of files to extract the tiers from
     * @param tierOrder the preferred tier order
     * @param selectedTiers the tiers to set selected
     * @param allowReordering if {@code true} reordering of the tiers will be allowed and the GUI will provide means for
     *     reordering
     */
    public FilesTierSortAndSelectPanel(List<File> files, List<String> tierOrder, List<String> selectedTiers,
                                       boolean allowReordering) {
        this(files, tierOrder, selectedTiers, allowReordering, true);
    }

    /**
     * Constructor for initializing the panel with a preferred tier order, a list of selected tiers and flags to indicate
     * whether or not reordering and sorting should be allowed.
     *
     * @param files the list of files to extract the tiers from
     * @param tierOrder the preferred tier order
     * @param selectedTiers the tiers to set selected
     * @param allowReordering if {@code true} reordering of the tiers will be allowed and the GUI will provide means for
     *     reordering
     * @param allowSorting if {@code true} GUI elements will added that support sorting of the tiers, e.g.
     *     alphabetically
     */
    public FilesTierSortAndSelectPanel(List<File> files, List<String> tierOrder, List<String> selectedTiers,
                                       boolean allowReordering, boolean allowSorting) {
        this(files, tierOrder, selectedTiers, allowReordering, allowSorting, Modes.ALL_TIERS);
    }

    /**
     * Constructor for initializing the panel with a preferred tier order, a list of selected tiers, flags to indicate
     * whether or not reordering and sorting should be allowed and the tier mode to start with.
     *
     * @param files the list of files to extract the tiers from
     * @param tierOrder the preferred tier order
     * @param selectedTiers the tiers to set selected
     ...
     */
    public FilesTierSortAndSelectPanel(List<File> files, List<String> tierOrder, List<String> selectedTiers,
                                       boolean allowReordering, boolean allowSorting, Modes tierMode) {
        super();
        this.files = files;
    ...
    /**
     * The map maps from each value (participant, type name, annotator, language) to a List of tier names in which that value
     * occurs.
     *
    ...
    /**
     * Switches dynamically between a view where only root tier are shown and the list of tiers for the mode of the panel.
     *
     * @param rootsOnly if {@code true} only root tiers are shown, otherwise the mode of the panel determines which tiers
     *     are visible
     */
    @Override
