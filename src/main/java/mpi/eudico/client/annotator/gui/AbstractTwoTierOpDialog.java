...
/**
 * An abstract dialog class enabling an operation where  two tiers are involved, typically a source and a destination tier.
 *
 * @author Han Sloetjes
 * @version Aug 2005 Identity removed
 */
@SuppressWarnings("serial")
public abstract class AbstractTwoTierOpDialog extends ClosableDialog implements ActionListener,
                                                                                ItemListener {
    /**
     * ui element
     */
     ...
     * direct child of the source  and must be of type tim-subdivision or symbolic-subdivision.
     */
    protected abstract void extractDestinationTiers();

    /**
     * Opens the edit tier dialog to let the user create a new candidate destination tier.
     */
    private void editTierDialog() {
        ...
        // this blocks...
        Command command = ELANCommandFactory.createCommand(transcription, ELANCommandFactory.EDIT_TIER);
    ...
    protected void updateLocale() {
        tierSelectionPanel.setBorder(new TitledBorder(ElanLocale.getString("TokenizeDialog.Label.SelectTiers")));
        sourceTierLabel.setText(ElanLocale.getString("TokenizeDialog.Label.SourceTier"));
        destTierLabel.setText(ElanLocale.getString("TokenizeDialog.Label.DestinationTier"));
        createTierButton.setText(ElanLocale.getString("TokenizeDialog.Button.NewTier"));
        optionsPanel.setBorder(new TitledBorder(ElanLocale.getString("TokenizeDialog.Label.Options")));
        existingLabel.setText(ElanLocale.getString("TokenizeDialog.Label.ExistingAnnotations"));
        overwriteRB.setText(ElanLocale.getString("TokenizeDialog.RadioButton.Overwrite"));
        preserveRB.setText(ElanLocale.getString("TokenizeDialog.RadioButton.Preserve"));
        emptyAnnCheckBox.setText(ElanLocale.getString("TokenizeDialog.Checkbox.EmptyAnnotations"));
