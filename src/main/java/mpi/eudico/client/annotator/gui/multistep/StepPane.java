...
public class StepPane extends JPanel implements Step {
    ...
    /**
     * Notification that this step will become the active step, moving up. The step can perform some preparations.
     */
    @Override
    ...
    /**
     * Called when the process has been cancelled. The step can clean up resources etc.
     */
    @Override
    ...
    /**
     * Called when to process has finished. The step can clean up etc.
     */
    @Override
    ...
    /**
     * Called when this step should perform the finishing action. The step can delegate the action to one of the other
     * steps.
     *
