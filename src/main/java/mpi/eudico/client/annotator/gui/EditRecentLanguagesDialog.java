...
/**
 * This dialog lets the user edit the "recently used languages" list (although it isn't called that any more for the user).
 * This is the list of languages as recently seen in multi-lingual CVs. From this list the user can choose a "Language for
