...
/**
 * The CompoundIcon will paint two, or more, Icons as a single Icon. The Icons are painted in the order in which they are
 * added.
 *
 * <p>The Icons are laid out on the specified axis:
 * <ul>
 ...
 * </ul>
 *
 * <p>Source: https://tips4java.wordpress.com/2009/03/29/compound-icon/
 */
public class CompoundIcon implements Icon {
    ...
    /**
     * top constant variable
     */
    public final static float TOP = 0.0f;
    /**
     * left constant variable
     */
    public final static float LEFT = 0.0f;
    /**
     * center constant variable
     */
    ...
    /**
     * Convenience constructor for creating a CompoundIcon where the icons are laid out on on the X-AXIS, the gap is 0 and
     ...
     *
     * @param axis the axis used to lay out the icons for painting. Must be one of the Axis enums: X_AXIS, Y_AXIS,
     *     Z_Axis.
     * @param icons the Icons to be painted as part of the CompoundIcon
     */
     ...
     *     Z_AXIS.
     * @param gap the gap between the icons
     * @param alignmentX the X alignment of the icons. Common values are LEFT, CENTER, RIGHT. Can be any value between
     *     0.0 and 1.0
     * @param alignmentY the Y alignment of the icons. Common values are TOP, CENTER, BOTTOM. Can be any value between
     *     0.0 and 1.0
     * @param icons the Icons to be painted as part of the CompoundIcon
     */
