...
public class SegmentTableModel extends AbstractTableModel {
    ...
    /**
     * Finds the List of the specified row and returns the value at the column index.
     *
     * @see javax.swing.table.TableModel#getValueAt(int, int)
     */
    @Override
    public Object getValueAt(int rowIndex, int columnIndex) {
        if ((rowIndex < 0) || (rowIndex >= tableData.size()) || (columnIndex < 0) || (columnIndex >= columnIds.size())) {
            return null;
        }
    ...
    /**
     * Returns the column index given the column name instead of the identifier constant.
     *
    ...
    public int findColumnByName(String columnName) {
        ...
        for (int i = 0; i < columnIds.size(); i++) {
            if (columnName.equals(ElanLocale.getString(LABEL_PREF + columnIds.get(i)))) {
                return i;
            }
        }
        return -1;
    ...
    /**
     * Returns the identifier of the column. Note: returns empty String when the column cannot be found
     *
     * @param columnIndex the column
     *
    ...
    public String getColumnName(int columnIndex) {
        ...
        return ElanLocale.getString(LABEL_PREF + columnIds.get(columnIndex));
    }

    /**
     * Returns the class of the data in the specified column. Note: returns null instead of throwing an
    ...
    /**
     * Note: silently returns instead of throwing an ArrayIndexOutOfBoundsException
     *
