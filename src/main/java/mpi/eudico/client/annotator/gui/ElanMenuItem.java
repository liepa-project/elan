...
/**
 * This class extends <code>JMenuItem</code> by getting the accelerator key from the key-value list and applying this to the
 * menu item.
 *
 * @author Han Sloetjes
 */
...
public class ElanMenuItem extends JMenuItem {
    /**
     * Constructor for ElanMenuItem. When there is an accelerator key defined it is applied to the menu item.
     *
    ...
    /**
     * Constructor for ElanMenuItem. When there is an accelerator key defined it is applied to the menu item. Accepts an
     * additional parameter to set the enabled state.
     *
     * @param a the Action for this menu item
