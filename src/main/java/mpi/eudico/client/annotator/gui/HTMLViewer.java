...
/**
 * Utility class for creating a Frame or a Dialog with a simple html viewer in a scrollpane. Based on the SimpleHTMLViewer in
 * the old nl.mpi.util package
 *
 * @author Han Sloetjes
 */
public class HTMLViewer implements HyperlinkListener {
     ...
     */
    public HTMLViewer(String urlString, boolean modal, String title) throws
                                                                     IOException {
        super();
    ...
    /**
     * For a frame the modal flag is used to determine whether the frame should always be on top.
     *
    ...
    public void hyperlinkUpdate(HyperlinkEvent e) {
        if (e.getEventType() == HyperlinkEvent.EventType.ACTIVATED) {
            ...
            if (e.getURL().sameFile(url)) {
                ...
                */
                try {
                    UrlOpener.openUrl(new URI(e.getURL().toExternalForm()), true);
    ...
    /**
     * Gives access to the actual html/editor pane so that clients can change the configuration of the viewer.
     *
