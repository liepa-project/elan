...
//	private final int MIN_VIEWER_HEIGHT = 120;
	...
	/** a list of redefined action constants */
	public static final List<String> REDEFINED_ACTIONS;
	static {
		REDEFINED_ACTIONS = List.of(ELANCommandFactory.SPLIT_ANNOTATION,
				ELANCommandFactory.MERGE_ANNOTATION_WB, ELANCommandFactory.MERGE_ANNOTATION_WN, 
				ELANCommandFactory.ANNOTATION_DOWN, ELANCommandFactory.ANNOTATION_UP,
				ELANCommandFactory.DELETE_ANNOTATION, ELANCommandFactory.REMOVE_ANNOTATION_VALUE,
				ELANCommandFactory.MODIFY_ANNOTATION_TIME, ELANCommandFactory.CANCEL_ANNOTATION_EDIT,
