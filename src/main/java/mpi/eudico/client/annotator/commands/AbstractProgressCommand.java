...
/**
 * An abstract command class for commands that do their work in a separate thread and report their progress to one or more
 * listeners.
 */
public abstract class AbstractProgressCommand implements Command {
     ...
     *
     * <p>In case of success this might result in a progressInterrupted call.
     */
