    ...
    public void execute(Object receiver, Object[] arguments) {
        if (receiver != null) {
            ...
            try {
                ...
                if ((oldLingType == null) || (!Objects.equals(lingTypeName, oldLingType.getLinguisticTypeName()))) {
                ...
                if ((langRef != null) && (!langRef.equals(oldLangRef))) {
    ...
    public void undo() {
        if (tier != null) {
            try {
                ...
                if (participant != null && !participant.equals(oldParticipant)) {
                    tier.setParticipant(oldParticipant);
                }

                if (annotator != null && !annotator.equals(oldAnnotator)) {
                ...
                LOG.log(Level.WARNING, "undo encountered a problem", ex);
                setWaitCursor(false);
            }
        }
    }
