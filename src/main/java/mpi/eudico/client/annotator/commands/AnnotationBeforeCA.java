 ...
 * @author Han Sloetjes
 */
public class AnnotationBeforeCA extends CommandAction implements ActiveAnnotationListener {
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.NEW_ANNOTATION_BEFORE);
    }

    /**
     * The receiver of this CommandAction is the TierImpl object on which the new annotation should be created.
     *
     * @return the receiver
     */
    @Override
     ...
     * This depends on the type of the annotation and the type of the Tier it belongs to.
     *
    ...
    /**
     * Enables or disables this <code>Action</code> depending on the caracteristics of the active annotation (and therefore
     * the tier it is on), if any.
     */
