...
/**
 * An action that listen to active annotation updates in order to enable/disable itself. It creates a new
 * {@link ModifyAnnotationTimeDlgCommand} which creates a dialog for modifying the active annotation's boundaries.
 *
 * @author Han Sloetjes
 */
...
public class ModifyAnnotationTimeDlgCA extends CommandAction implements ActiveAnnotationListener {
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.MODIFY_ANNOTATION_TIME_DLG);
    }
    ...
    public void updateActiveAnnotation() {
        ...
        setEnabled(activeAnnotation instanceof AlignableAnnotation);
    }
