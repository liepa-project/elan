...
/**
 * A command that creates a import Praat grid dialog, parses the file and adds (interval) tiers and annotations to the
 * transcription.
 */
public class ImportPraatGridDlgCommand implements Command {
    ...
    public void execute(Object receiver, Object[] arguments) {
        ...
        StepPane step1 = new ImportPraatTGStep1(pane, false);
        ...
        JDialog dialog = pane.createDialog(ELANCommandFactory.getRootFrame(trans),
                                           ElanLocale.getString("Menu.File.Import.PraatTiers"),
                                           true);
