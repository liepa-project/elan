...
/**
 * A command that activates a annotation and starts editing at once.
 *
 * @author Han Sloetjes
 * @version Aug 2008
 */
public class ActiveAnnotationEditCommand implements Command {
     ...
     * @param arguments the arguments:  <ul><li>arg[0] = the annotation to activate and edit (Annotation)</li> </ul>
     */
    @Override
