...
/**
 * A Command that creates a new Transcription, copies CV's, LinguisticTypes, Tiers and the annotations within/overlapping the
 * selected time interval. All copied annotations are forced in to the interval.
 *
 * @author Han Sloetjes
 */
public class SaveSelectionAsEafCommand implements Command {
    ...
    /**
     * Creates a new Transcription and adds copies of CV's, Linguistic Types, Tiers and the annotations within the selection.
     * Overlapping annotations will be forced into the selectioninterval.
     * <b>Note: </b>it is assumed the types and order of the arguments
     * are correct.
     *
     * @param receiver the transcription
     * @param arguments the arguments: <ul><li>arg[0] = the selection begin time (Long)</li> <li>arg[1] the selection end
     *     time (Long)</li> </ul>
     */
    @Override
