...
/**
 * A CommandAction that brings up a JDialog for defining and editing Controlled Vocabularies.
 *
 * @author Han Sloetjes
 */
public class EditCVDlgCA extends CommandAction {
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.EDIT_CV_DLG);
    }
