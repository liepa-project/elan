...
/**
 * A Command to play the selection, possibly in a loop and/or with a modified play back rate
 */
public class PlaySelectionCommand implements Command {
     ...
     * @param arguments the Selection, the player controller, the "play around" value and optionally a play back rate
     */
    @Override
    public void execute(Object receiver, Object[] arguments) {
        ...
        if ((!player.isPlaying()) && (mediaTime >= beginTime) && (mediaTime < endTime - 5)) {
    ...
    /**
     * Play the selection after changing the rate. After play selection stopped the rate should be set to the old value.
     *
    ...
    private class LoopThread extends Thread {
        ...
        @Override
        public void run() {
            if (mediaPlayerController.isPlaySelectionMode() && mediaPlayerController.getLoopMode()) {
