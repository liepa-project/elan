...
/**
 * A command to add a link to a lexicon and a specific field in its entry to the transcription.
 */
public class AddLexLinkCommand implements UndoableCommand {
     ...
     * @param arguments the arguments: arg[0] = the Lexicon Link object (LexiconLink)
     */
    @Override
