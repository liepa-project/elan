...
/**
 * Shows a save dialog and passes the selected filepath to the Preferences export method.
 *
 * @author Han Sloetjes
 * @version 1.0
 */
public class ExportPrefsCommand implements Command {
     ...
     *
     * @param receiver the Transcription/document of which to save the preferences
    ...
    private String promptForExportFile() {
        ...
        chooser.createAndShowFileDialog(ElanLocale.getString("ExportDialog.ExportToFile"),
                                        FileChooser.SAVE_DIALOG,
                                        FileExtension.ELAN_XML_PREFS_EXT,
                                        "LastUsedExportDir");
