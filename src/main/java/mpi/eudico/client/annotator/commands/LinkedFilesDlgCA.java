...
/**
 * A CommandAction that brings up a JDialog with an overview of all linked files and with controls to edit the linked  files
 * collection.
 *
 * @author Han Sloetjes
 */
public class LinkedFilesDlgCA extends CommandAction {
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.LINKED_FILES_DLG);
    }
