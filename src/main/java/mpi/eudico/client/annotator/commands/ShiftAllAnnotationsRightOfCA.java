...
/**
 * Shift the annotations on all (root) tiers that are completely located to the right of the crosshair.
 *
 * @author Han Sloetjes
 * @version 1.0
 */
public class ShiftAllAnnotationsRightOfCA extends ShiftAnnotationsRightOfCA {
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.SHIFT_ANN_ALLTIER_DLG);
    }
