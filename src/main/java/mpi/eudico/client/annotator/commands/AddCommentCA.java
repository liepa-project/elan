...
public class AddCommentCA extends CommandAction implements ActiveAnnotationListener {
    /**
    ...
    /**
     * The receiver of this CommandAction is the ??? object on which the new comment should be created.
     *
    ...
    /**
     * Enables or disables this <code>Action</code> depending on the characteristics of the active annotation (and therefore
     * the tier it is on), if any. In this case it only checks if there is an active annotation at all.
     */
