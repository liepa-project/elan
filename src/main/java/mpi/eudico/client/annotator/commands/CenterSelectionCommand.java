...
/**
 * A command to position the selection horizontally in the center of the Timeline viewer.
 *
 * @author Han Sloetjes
 */
    ...
    public void execute(Object receiver, Object[] arguments) {
        if (receiver instanceof ViewerManager2) {
            if (!((ViewerManager2) receiver).getMasterMediaPlayer().isPlaying()) {
                ...
                if ((elm.getVisibleMultiTierViewer() == elm.getTimeLineViewer()) && (s.getBeginTime() != s.getEndTime())) {
                    ...
                    if ((newBT + (et - bt)) > ((ViewerManager2) receiver).getMasterMediaPlayer().getMediaDuration()) {
                        newBT = ((ViewerManager2) receiver).getMasterMediaPlayer().getMediaDuration() - (et - bt);
                    }

                    elm.getTimeLineViewer().setIntervalBeginTime((newBT < 0) ? 0 : newBT);
                }
            }
        }
    }
