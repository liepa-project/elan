...
/**
 * Sets the next (down) or previous (up) tier active in the multitier control panel  and thus in the TimeLineViewer.
 *
 * @author Han Sloetjes
 */
public class ActiveTierCommand implements Command {
     ...
     * @param arguments the arguments:  <ul><li>arg[0] = the direction of activation,  next tier (vertically down) or
     *     previous tier (vertically up). True means next (down), false means previous (down).  (Boolean)</li> </ul>
     */
    @Override
