...
public class MultiEAFScrubberMA extends AbstractProcessMultiMA {
    ...
    /**
     * Creates a dialog to configure which characters to remove from annotations. Leading or trailing spaces or all sequences
     * of multiple spaces, leading, trailing or all new line characters and leading, trailing or all tabs.
     *
     * @param e the event
     */
    @Override
    public void actionPerformed(ActionEvent e) {
        ...
        if (option == JOptionPane.YES_OPTION) {
            List<File> files = getMultipleFiles(frame, ElanLocale.getString("ExportDialog.AnnotationList.Title"));
