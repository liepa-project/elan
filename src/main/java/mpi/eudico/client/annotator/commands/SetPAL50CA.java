...
/**
 * CommandAction to manually set the video frame rate to PAL(?) 50 fps. This only influences the number of milliseconds per
 * frame for Elan.<br> 50 frames per second results in 1000 / 50 = 20 milliseconds per frame.
 *
 * @author Han Sloetjes
 */
...
public class SetPAL50CA extends CommandAction {
     ...
     */
    private final Object[] args = new Object[] {Double.valueOf(20d)};
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.SET_PAL_50);
    }
