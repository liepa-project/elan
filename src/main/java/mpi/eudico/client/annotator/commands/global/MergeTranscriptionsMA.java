...
/**
 * Creates a merge transcriptions menu action. Opens the wizard without a preloaded transcription.
 *
 * @author Han Sloetjes
 * @version 1.0
 */
...
public class MergeTranscriptionsMA extends FrameMenuAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        JDialog jd = pane.createDialog(frame, ElanLocale.getString("MergeTranscriptionDialog.Title"), true);
        jd.pack();
