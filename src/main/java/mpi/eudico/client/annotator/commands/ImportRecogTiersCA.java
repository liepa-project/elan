...
/**
 * A command action to import tiers from an AVATecH recognizer TIER file, csv or xml.
 *
 * @author Han Sloetjes
 */
public class ImportRecogTiersCA extends CommandAction {
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.IMPORT_RECOG_TIERS);
    }
