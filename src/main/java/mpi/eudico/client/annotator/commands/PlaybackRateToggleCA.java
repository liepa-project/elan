...
/**
 * A CommandAction that stores and sets the toggle value for  the playback rate shortcut.
 *
 * @author Han Sloetjes
 */
public class PlaybackRateToggleCA extends CommandAction {
    ...
    /**
     * Creates a new PlaybackRateToggleCommand. Every time newCommand is called the rate value should be toggled.
     */
    @Override
    protected void newCommand() {
        isToggled = !isToggled;

        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.PLAYBACK_RATE_TOGGLE);
    }
    ...
    /**
     * Sets the toggle value. The value should be between 0 and 200, inclusive.
     *
