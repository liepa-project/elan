...
public class DeleteAnnotationCommand implements UndoableCommand {
    ...
    public void undo() {
        if ((tier != null) && (annRootNode != null)) {
            ...
            AnnotationRecreator.createAnnotationFromTree(tier.getTranscription(), annRootNode, true);
     ...
     * @param arguments the arguments:  <ul><li>arg[0] = the Viewer Manager (ViewerManager2)</li> <li>arg[1] = the
     *     annotation (Annotation)</li> </ul>
     */
    @Override
