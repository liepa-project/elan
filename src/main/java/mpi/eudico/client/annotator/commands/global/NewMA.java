...
public class NewMA extends FrameMenuAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        chooser.createAndShowMultiFileDialog(ElanLocale.getString("Frame.ElanFrame.NewDialog.Title"),
                                             FileChooser.MEDIA_TEMPLATE);
    ...
    /**
     * constructs the initial (default) tier and its  default type
     *
