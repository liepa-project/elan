...
public class ModifyAnnotationCommand implements UndoableCommand,
    ...
    /**
     * The undo action. We can not just use an object reference to the annotation because the annotation might have been
     * deleted and recreated between the  calls to the execute and undo methods. The reference would then be invalid.
     */
    @Override
    public void undo() {
            ...
            if ((annotation != null) && (annotation.getEndTimeBoundary() == annotationRecord.getEndTime())) {
                ...
                if (MonitoringLogger.isInitiated()) {
                    MonitoringLogger.getLogger(transcription)
                                    .log(MonitoringLogger.UNDO, MonitoringLogger.CHANGE_ANNOTATION_VALUE);
                }
            }
        }
    }
    ...
    public void redo() {
        if ((annotationRecord != null) && (transcription != null)) {
            ...
            if ((annotation != null) && (annotation.getEndTimeBoundary() == annotationRecord.getEndTime())) {
                ...
                if (MonitoringLogger.isInitiated()) {
                    MonitoringLogger.getLogger(transcription)
                                    .log(MonitoringLogger.REDO, MonitoringLogger.CHANGE_ANNOTATION_VALUE);
                }
            }
        }
    }
        ...
        if (annotation != null) {
            ...
            if (arguments.length >= 3) {
                ...
                try {
                    ...
                    LOG.log(Level.WARNING, "Cloning issue.", e);
                }
                newExtRef = eri;
    ...
    /**
     * Replaces external reference
     *
     * @param annotation the annotation
     * @param eri the external reference
     */
