...
/**
 * Action to center the selection in the Timeline viewer. Note: could implement SelectionListener to enable and disable the
...
public class CenterSelectionCA extends CommandAction {
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.CENTER_SELECTION);
    }
