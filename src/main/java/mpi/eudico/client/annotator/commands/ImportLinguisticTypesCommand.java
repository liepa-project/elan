...
/**
 * A Command to import Linguistic Types (and referenced Controlled Vocabularies) from an .eaf or .etf file into an existing
 * transcription.
 */
public class ImportLinguisticTypesCommand implements UndoableCommand {
    ...
    private final List<LinguisticType> typesAdded = new ArrayList<LinguisticType>();
    private final List<ControlledVocabulary> cvsAdded = new ArrayList<ControlledVocabulary>();
    private final List<LexiconLink> lexLinksAdded = new ArrayList<LexiconLink>();
