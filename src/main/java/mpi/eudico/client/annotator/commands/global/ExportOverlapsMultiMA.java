...
/**
 * A action that creates a dialog for exporting annotation overlap information for multiple files.
 *
 * @author Han Sloetjes
 */
...
public class ExportOverlapsMultiMA extends AbstractProcessMultiMA {
    ...
    public void actionPerformed(ActionEvent e) {
        List<File> files = getMultipleFiles(frame, ElanLocale.getString("ExportDialog.Multi"));
        ...
        JDialog dialog = pane.createDialog(frame, ElanLocale.getString("ExportOverlapsDialog.Title"), true);
        dialog.pack();
