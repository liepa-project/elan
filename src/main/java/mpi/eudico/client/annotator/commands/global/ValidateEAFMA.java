...
/**
 * An action to create and show a report of a validation of an EAF file. Errors are reported but not repaired.
 */
...
public class ValidateEAFMA extends FrameMenuAction {
    ...
    /**
     * Shows a File Chooser, creates and start a validator and shows the process report.
     */
    @Override
    ...
    /**
     * A thread to show an indeterminate progress dialog and to start the validation process.
     */
    private class ValidationThread extends Thread {
        ...
        /**
         * Creates a progress monitor, starts the validator and shows the process report at the end of the validation
         * process.
         */
        @Override
        public void run() {
            if (validator != null) {
                IndeterminateProgressMonitor progMonitor = new IndeterminateProgressMonitor(null,
                                                                                            false,
