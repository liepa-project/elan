...
public class ExportFlexDlgCommand implements Command {
    ...
    public void execute(Object receiver, Object[] arguments) {
        if (arguments[0] instanceof TranscriptionImpl transcription) {
            ...
            JDialog dialog = multipane.createDialog(ELANCommandFactory.getRootFrame(transcription),
                                                    ElanLocale.getString("ExportFlexDialog.Title"),
                                                    true);
