...
/**
 * Shows a file chooser and next creates an import options window for tab delimited or csv file.
 *
 * @author Han Sloetjes
 */
...
public class ImportDelimitedTextMA extends FrameMenuAction {
    ...
    /**
     * Creates a chooser to select a .csv or .txt file or other separated text file and next creates an import delimited text
     * dialog.
     *
