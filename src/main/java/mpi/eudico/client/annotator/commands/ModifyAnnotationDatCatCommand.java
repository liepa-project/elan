...
/**
 * Modifies the reference to an ISO data category. Note: does not yet handle compound references!
 *
 * @author Han Sloetjes
 */
public class ModifyAnnotationDatCatCommand implements UndoableCommand {
        ...
        if ((annotationRecord != null) && (transcription != null)) {
            ...
            if ((annotation != null) && (annotation.getEndTimeBoundary() == annotationRecord.getEndTime())) {
                ...
                if (newValue == null) {
                    ...
                    annotation.addExtRef(new ExternalReferenceImpl(newValue, ExternalReference.ISO12620_DC_ID));
                }
            }
        }
    }
        ...
        if ((annotationRecord != null) && (transcription != null)) {
            ...
            if ((annotation != null) && (annotation.getEndTimeBoundary() == annotationRecord.getEndTime())) {
                ...
                if (oldValue == null) {
                    ...
                    annotation.addExtRef(new ExternalReferenceImpl(oldValue, ExternalReference.ISO12620_DC_ID));
                }
            }
        }
    }
     ...
     * @param arguments the arguments:  <ul><li>arg[0] = the new value of the annotation data category reference
     *     (String)</li> </ul>
     */
    @Override
