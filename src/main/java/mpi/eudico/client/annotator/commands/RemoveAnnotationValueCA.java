 ...
 */
public class RemoveAnnotationValueCA extends CommandAction implements ActiveAnnotationListener {
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.REMOVE_ANNOTATION_VALUE);
    }

    /**
     * The receiver of this CommandAction is the Annotation for which the value should be removed.
     *
