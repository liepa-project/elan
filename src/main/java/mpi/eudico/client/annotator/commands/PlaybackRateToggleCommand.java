...
/**
 * A Command that actually changes the playback rate of the master media player and that updates the rate slider.
 *
 * @author Han Sloetjes
 */
public class PlaybackRateToggleCommand implements Command {
    ...
    /**
     * Changes the rate of the master media player and updates the user interface. <b>Note: </b>it is assumed the types and
