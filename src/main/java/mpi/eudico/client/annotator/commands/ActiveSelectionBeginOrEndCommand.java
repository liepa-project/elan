...
/**
 * Command to move the crosshair explicitly to either begin or end of the selection. This is independent of the concept of
 * "active boundary" (as used by the ActiveSelectionBoundaryCommand).
 *
...
public class ActiveSelectionBeginOrEndCommand implements Command {
     ...
     * @param arguments <ul><li>arguments[0] = the Selection object (Selection)</li>
