 ...
 * @author Han Sloetjes
 */
public class UpdateTranscriptionsForECVCommand implements Command,
                                                          ProcessReporter {
     ...
     *     <li>arg[1] = the path to an output folder, if null the source folder is the destination
     *     folder (String)</li>
     *     <li>arg[2] = flag for recursive processing (Boolean)</li>
     *     <li>arg[3] = language</li>
     *     <li>arg[4] = flag for letting the annotation values take precedence over a CVEntry reference
     *     (Boolean, optional)</li>
     *     </ul>
     */
    @Override
    public void execute(Object receiver, Object[] arguments) {
        ...
        int success =
            corpusECVUpdater.updateFiles(new String[] {(String) arguments[0], (String) arguments[1]}, (String) arguments[3]);
