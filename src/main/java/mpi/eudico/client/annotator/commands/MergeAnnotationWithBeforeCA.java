 ...
 * @version 1.0
 */
public class MergeAnnotationWithBeforeCA extends CommandAction implements ActiveAnnotationListener {
    /**
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.MERGE_ANNOTATION_WB);
    }
