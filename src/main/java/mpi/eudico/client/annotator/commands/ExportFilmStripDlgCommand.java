...
/**
 * A command that creates a dialog for configuring filmstrip + waveform image creation.
 *
 * @author Han Sloetjes
 * @version 1.0
 */
public class ExportFilmStripDlgCommand implements Command {
    ...
    public void execute(Object receiver, Object[] arguments) {
        ...
        ExportFilmStripDialog dialog = new ExportFilmStripDialog(ELANCommandFactory.getRootFrame(vm.getTranscription()),
                                                                 players,
                                                                 wavFile,
                                                                 vm.getSelection());
