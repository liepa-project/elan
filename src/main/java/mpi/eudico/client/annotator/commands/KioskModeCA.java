...
/**
 * A class to switch to and from Kisok Mode. In this mode the player will play the complete media file in a loop, all
...
public class KioskModeCA extends CommandAction {
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.KIOSK_MODE);
    }
