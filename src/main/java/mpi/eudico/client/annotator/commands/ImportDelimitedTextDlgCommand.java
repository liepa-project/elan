...
/**
 * A command that creates an import CSV or tab-delimited text dialog, gets the settings from the dialog and starts the
 * actual, undoable import process.
 */
public class ImportDelimitedTextDlgCommand implements Command {
    ...
    /**
     * Prompts for a file name and creates the import dialog. The dialog might depend on the type of the selected file.
     *
    ...
    public void execute(Object receiver, Object[] arguments) {
        ...
        if (csvFile != null) {
            ...
            if (value == null || !(value instanceof DelimitedTextDecoderInfo decInfo)) {
                return;
            }
