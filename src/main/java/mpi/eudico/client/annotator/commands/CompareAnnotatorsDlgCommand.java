 ...
 *
 * @version 2 Jan 2015: this command now creates the multiple file, multiple step version of the inter-annotator reliability
 *     calculation process. This new version supports multiple algorithms for this calculation.
 */
