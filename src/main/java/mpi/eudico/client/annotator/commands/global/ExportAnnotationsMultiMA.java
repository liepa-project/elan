...
/**
 * Creates a dialog to select tiers from multiple files for a annotation list export.
 *
 * @author Han Sloetjes
 * @version 1.0
 */
...
public class ExportAnnotationsMultiMA extends AbstractProcessMultiMA {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        new ExportWordListDialog(frame, true, files, WordListEncoderInfo.ANNOTATIONS).setVisible(true);
    }
}
