...
public class ExportWordsDialogCommand implements Command {
     ...
     *
     * @param receiver null
     * @param arguments the arguments:  <ul><li>arg[0] = the Transcription object(Transcription)</li> </ul>
     */
    @Override
    public void execute(Object receiver, Object[] arguments) {
        TranscriptionImpl transcription = (TranscriptionImpl) arguments[0];
        new ExportWordListDialog(ELANCommandFactory.getRootFrame(transcription), true, transcription).setVisible(true);
    }
