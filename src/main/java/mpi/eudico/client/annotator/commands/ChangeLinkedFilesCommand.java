...
public class ChangeLinkedFilesCommand implements UndoableCommand {
    ...
    /**
     * Tries to update the mediaplayers in the viewermanager as well as the layoutmanager and finally sets the
    ...
    /**
     * Tries to update the existing mediaplayers and viewers in the viewermanager as well as the layoutmanager and the media
     * descriptors in the transcription.
     *
     * @param transcription the Transcription with the old descriptors
    ...
    /**
     * Updates the offsets of the timeseries tracks and of the media descriptors in the transcription.
     *
