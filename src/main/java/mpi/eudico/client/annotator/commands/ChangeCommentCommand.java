 ...
 *
 * <p>To change a comment's identity, even the MessageID may be changed.
 * Since commentManager.replace() is called, even the time (and thereby the position) may be different.
 *
 * @author Olaf Seibert
 */
public class ChangeCommentCommand implements UndoableCommand {
     ...
     * Change a comment.
     *
     * <p>Receiver: the CommentManager.
     *
     * <p>Arguments:<br>
     * [0] Integer: position of the comment <br> [1] CommentEnvelope: new version of it
     */
