 ...
 * @version Jan 2016 Added PAL 50 frames per second. Note that in the preferences (media pref panel) at some point a change
 *     has been made to store non-localized values from Constants, checks for that have added now as well.
 */

public class CopyCurrentTimeToPasteBoardCommand implements Command {
    private final String commandName;

    private static final String HH_MM_SS_MS = ElanLocale.getString("TimeCodeFormat.Hours");
    private static final String SS_MS = ElanLocale.getString("TimeCodeFormat.Seconds");
    private static final String MS = ElanLocale.getString("TimeCodeFormat.MilliSec");
    private static final String NTSC = ElanLocale.getString("TimeCodeFormat.TimeCode.SMPTE.NTSC");
    private static final String PAL = ElanLocale.getString("TimeCodeFormat.TimeCode.SMPTE.PAL");
    private static final String PAL_50 = ElanLocale.getString("TimeCodeFormat.TimeCode.SMPTE.PAL50");
