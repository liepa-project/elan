...
public class DeleteCVCommand implements UndoableCommand {
     ...
     * @param arguments the arguments: <ul><li>arg[0] = the  Controlled Vocabulary  (Controlled Vocabulary)</li> </ul>
     */
    @Override
    public void execute(Object receiver, Object[] arguments) {
        ...
        if (transcription != null) {
            affectedTypes = transcription.getLinguisticTypesWithCV(controlledVocabulary.getName());
            transcription.removeControlledVocabulary(controlledVocabulary);
        }
    }
