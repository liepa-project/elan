...
public class ZoomCommand implements Command {
     ...
     * @param arguments arg[0] = -1, 0, 1, or any &gt;= 10 (Integer). -1 = zoom out, 0 = default zoom level, 1 = zoom in,
     *     &gt;= 10 = a zoom level Depending on the current "mode" the actual receiver will be a specific time scale based
     *     viewer.
     */
    @Override
