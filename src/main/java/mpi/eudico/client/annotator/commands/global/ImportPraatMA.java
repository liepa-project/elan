...
/**
 * Imports a Praat TextGrid file into an empty, just-in-time created transcription.
 *
 * @author Han Sloetjes
 * @version 1.0
...
public class ImportPraatMA extends FrameMenuAction {
    ...
    /**
     * Creates a new transcription with one linguistic type and  shows the import Praat wizard.
     *
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        StepPane step1 = new ImportPraatTGStep1(pane, true);
        StepPane step2 = new ImportPraatTGStep2(pane, (TranscriptionImpl) transcription);
        StepPane step3 = new ImportPraatTGStep3(pane, transcription, true);

        pane.addStep(step1);
        pane.addStep(step2);
        pane.addStep(step3);

        JDialog dialog = pane.createDialog(frame, ElanLocale.getString("Menu.File.Import.PraatTiers"), true);
