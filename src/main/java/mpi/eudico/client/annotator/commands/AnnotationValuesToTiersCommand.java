...
/**
 * A command that takes the annotation values of a tier and creates a tier for each value and adds (empty) annotations to
 * those tiers according to the annotation values on the input tier.
 *
 * @author Han Sloetjes
 */
public class AnnotationValuesToTiersCommand implements UndoableCommand {
     ...
     * @param arguments the arguments for this command<br> arguments[0] = the name of the input tier (String)<br>
    ...
    public void execute(Object receiver, Object[] arguments) {
        ...
        sourceTier = transcription.getTierWithId(sourceTierName);
        if (sourceTier == null) {
