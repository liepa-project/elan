...
/**
 * A Command that actually changes the playback volume of the master media player and that updates the rate slider.
 *
 * @author Han Sloetjes
 */
public class PlaybackVolumeToggleCommand implements Command {
    ...
    /**
     * Changes the volume of the master media player and updates the user interface. <b>Note: </b>it is assumed the types and
     * order of the arguments are correct.
     *
     * @param receiver the viewer manager
     * @param arguments the arguments: <ul><li>arg[0] = the new value for the playback rate toggle (Float)</li> </ul>
     */
    @Override
