...
/**
 * An action that creates an export toolbox dialog. The export differs from the Shoebox export in the following way:<br> - a
 * larger number of user options <br> - it only supports utf-8 export
 *
 * @author Han Sloetjes
 * @version 1.0
 */
public class ExportToolboxDlgCA extends CommandAction {
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.EXPORT_TOOLBOX);
    }
