...
/**
 * A Command to paste an annotation (i.e. a transferable AnnotationDataRecord) from the System's Clipboard.
 *
...
public class PasteAnnotationCommand extends NewAnnotationCommand {
    private AnnotationDataRecord annotationDataRecord;
    ...
    public void redo() {
        ...
        if (newAnnotation != null && annotationDataRecord != null) {
     ...
     * following order is used to decide on which tier the annotation has te be pasted:<br> - the tier of the same name as in
     * the copied annotation record, if present in the destination transcription<br> - the current active tier
     *
    ...
    public void execute(Object receiver, Object[] arguments) {
        ...
        if (canAccessSystemClipboard()) {
            ...
            if (contents instanceof DefaultMutableTreeNode node) {
            ...
            if (destTierName != null) {
                tier = tr.getTierWithId(destTierName);
            }
