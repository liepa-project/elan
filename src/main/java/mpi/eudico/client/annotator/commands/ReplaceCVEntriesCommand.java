...
/**
 * A Command to replace the existing CVEntries in a Controlled Vocabulary  by a new array of CVEntries.
 *
 * @author Han Sloetjes
 */
public class ReplaceCVEntriesCommand implements Command {
     ...
     * @param arguments the arguments: <ul><li>arg[0] = an array of entries to replace the exisitng entries
     *     (CVEntry[])</li> </ul>
     */
    @Override
