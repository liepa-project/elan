...
public class ActiveAnnotationCommand implements Command {
    ...
    /**
     * Added support for an additional argument that determines whether or not the crosshair may be moved.<br> Version 01
     * 2013: added argument
     *
     * @param receiver the ViewerManager
     * @param arguments arg[0] = the annotation to activate (can be null) (Annotation) arg[1] = flag to indicate whether
     *     the media time may be changed (Boolean)
     */
    @Override
    public void execute(Object receiver, Object[] arguments) {
        ...
        if (annot != null) {
            if (annot instanceof AlignableAnnotation) {
                ...
                if (parent instanceof AlignableAnnotation aa) {
