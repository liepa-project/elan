...
public class DeleteAnnotationsCommand implements UndoableCommand {
     ...
     * @param arguments the arguments:  <ul><li>arg[0] = the Tier (TierImpl)</li> <li>arg[1] = the begin time of the
     *     interval (Long)</li> <li>arg[2] = the end time of the interval (Long)</li> </ul>
     */
    @Override
    ...
    private void storeAnnotationTrees(TierImpl tier, long begin, long end) {
        ...
        if (tier != null) {
            ...
            for (int i = 0; i < annos.size(); i++) {
                ...
                if ((annotation.getBeginTimeBoundary() >= begin) && (annotation.getEndTimeBoundary() <= end)) {
