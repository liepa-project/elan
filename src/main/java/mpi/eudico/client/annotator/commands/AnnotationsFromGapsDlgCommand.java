...
public class AnnotationsFromGapsDlgCommand implements Command {
    ...
    public void execute(Object receiver, Object[] arguments) {
        ...
        long mediaDuration = ELANCommandFactory.getViewerManager(trans).getMasterMediaPlayer().getMediaDuration();

        AnnotationsFromGapsDlg dialog =
            new AnnotationsFromGapsDlg(ELANCommandFactory.getRootFrame(trans), trans, mediaDuration);
