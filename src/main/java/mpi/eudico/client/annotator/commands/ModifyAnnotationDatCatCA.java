...
/**
 * A CommandAction that creates a dialog by which the data category reference of an annotation can be set.
 *
 * @author Han Sloetjes
 */
public class ModifyAnnotationDatCatCA extends CommandAction implements ActiveAnnotationListener {
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.MODIFY_ANNOTATION_DC_DLG);
    }
