...
/**
 * A Command to replace an existing Controlled Vocabulary in a Transcription by a new Controlled Vocabulary.
 *
 * @author Han Sloetjes
 */
public class ReplaceCVCommand implements UndoableCommand {
    ...
    /**
     * Replacing a ControlledVocabulary comes down to deleting the old one  and adding the new one in one
     * (action)command.<br> May 2013: linguistic types linked to the replaced CV are now updated to use the new CV.<br>
     * <b>Note: </b>it is assumed the types and order of the arguments are
     * correct.
     *
     * @param receiver the Transcription
     * @param arguments the arguments:  <ul><li>arg[0] = the old Controlled Vocabulary (Controlled Vocabulary)</li>
     *     <li>arg[1] = the the new Controlled Vocabulary (Controlled Vocabulary)</li> </ul>
     */
    @Override
    public void execute(Object receiver, Object[] arguments) {
        ...
        if ((transcription.getControlledVocabulary(conVoc.getName()) != null) && (newConVoc != null)) {
            List<LinguisticType> typesWithThisCV = transcription.getLinguisticTypesWithCV(conVoc.getName());
