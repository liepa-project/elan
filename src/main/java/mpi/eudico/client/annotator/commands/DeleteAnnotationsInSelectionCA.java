...
public class DeleteAnnotationsInSelectionCA extends CommandAction implements SelectionListener {
    /**
     * Creates the action.
     *
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.DELETE_ANNOS_IN_SELECTION);
    }

    /**
     * Returns the arguments for the command.
     *
     * @return array containing the active tier, selection begin time and end time, or null
     *
    ...
    protected Object[] getArguments() {
        if (vm.getMultiTierControlPanel().getActiveTier() != null) {
            ...
            return new Object[] {vm.getMultiTierControlPanel().getActiveTier(), bt, et};
        }
    ...
    /**
     * If there is a selection this action will be enabled, otherwise it will be disabled.
     */
    @Override
