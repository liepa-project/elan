...
/**
 * A menu action that creates a dialog to edit the locally stored ISO 12620 Data Category selection.
 *
 * @author Han Sloetjes
 * @version 1.0
 */
...
public class EditLocalDCRMA extends FrameMenuAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ELANDCRDialog dialog = new ELANDCRDialog(frame, true, ELANDCRDialog.LOCAL_MODE);
        dialog.pack();
