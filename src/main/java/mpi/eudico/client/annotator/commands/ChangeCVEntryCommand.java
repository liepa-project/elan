...
public class ChangeCVEntryCommand implements Command {
     ...
     * @param arguments the arguments: <ul><li>arg[0] = the old value of the entry (String)</li> <li>arg[1] = the new
     *     value of the entry (String)</li> <li>arg[2] = the description of the entry</li><li>arg[3] = the language index of
     *     the value</li></ul>
     */
    @Override
