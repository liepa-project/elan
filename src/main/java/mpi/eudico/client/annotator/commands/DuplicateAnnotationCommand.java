...
/**
 * An undoable command that builds on the new annotation command. It takes the active annotation as input, creates a new
 * annotation and sets the value for the new annotation to be the same as the input annotation. This is then one undoable
 * command in the undo/redo list.
 */
public class DuplicateAnnotationCommand extends NewAnnotationCommand {
     ...
     * @param arguments the arguments:  <ul><li>arg[0] = the tier (TierImpl)</li> <li>arg[1] = the annotation to
     *     duplicate (Annotation)</li>  </ul>
     */
    @Override
    public void execute(Object receiver, Object[] arguments) {
        ...
        if (times != null) {
            ...
            Command c = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.ACTIVE_ANNOTATION);
    ...
    /**
     * Adjust the begin and end time for the new annotation based on tier type and parent tier and parent annotation.
     *
