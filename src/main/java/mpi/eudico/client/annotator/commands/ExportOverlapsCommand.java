...
public class ExportOverlapsCommand implements Command {
    ...
    public void execute(Object receiver, Object[] arguments) {
        ...
        if (outWriter == null && arguments.length > 3) {
            try {
                singleWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream((String) arguments[3]),
    ...
    /**
     * Calculates and writes overlap information from one transcription to the output stream. Always one tier is iteratively
     * compared with one or more other tiers, for each of the other tiers a number of columns is added. TO DO: what columns
     * to export should be made flexible
     *
     ...
     */
    private void exportOverlaps(Writer outWriter, TranscriptionImpl tr, String refTier, List<String> compTiers) throws
                                                                                                                IOException {
        ...
        Map<String, List<AbstractAnnotation>> annosForTiers =
            new HashMap<String, List<AbstractAnnotation>>(compTiers.size());
