...
/**
 * An action to create a dialog for configuration of filmstrip + waveform output.
 *
 * @author Han Sloetjes
 * @version 1.0
 */
public class ExportFilmStripCA extends CommandAction {
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.EXPORT_FILMSTRIP);
    }
