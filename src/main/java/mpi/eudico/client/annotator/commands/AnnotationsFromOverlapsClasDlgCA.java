...
public class AnnotationsFromOverlapsClasDlgCA extends CommandAction {
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.ANN_FROM_OVERLAP_COM_CLAS);
    }
    ...
    public void updateLocale() {
        ...
        // putValue(Action.SHORT_DESCRIPTION, ElanLocale.getString(ELANCommandFactory.ANN_FROM_OVERLAP + "ToolTip") +
        // " (Classic)");
    }
