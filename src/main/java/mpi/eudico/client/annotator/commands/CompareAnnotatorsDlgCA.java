 ...
 *
 * @version Jan 2015 this action now uses the ANNOTATOR_COMPARE_MULTI constant to create the command.
 */
...
public class CompareAnnotatorsDlgCA extends CommandAction {
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.ANNOTATOR_COMPARE_MULTI);
    }
