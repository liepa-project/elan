...
/**
 * A CommandAction to copy an annotation (i.e. a transferable AnnotationDataRecord) to the System's Clipboard.
 */
public class CopyAnnotationCA extends CommandAction implements ActiveAnnotationListener {
    ...
    protected void newCommand() {
        command = ELANCommandFactory.createCommand(vm.getTranscription(), ELANCommandFactory.COPY_ANNOTATION);
    }
