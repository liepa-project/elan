...
/**
 * Creates a dialog to select tiers from multiple files for tab delimited text export.
 *
 * @author Han Sloetjes
 * @version 1.0
 */
...
public class ExportTabMultiMA extends AbstractProcessMultiMA {
    ...
    public void actionPerformed(ActionEvent e) {
        List<File> files = getMultipleFiles(frame, ElanLocale.getString("ExportTiersDialog.Title"));
