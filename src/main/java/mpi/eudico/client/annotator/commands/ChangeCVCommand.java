...
public class ChangeCVCommand implements UndoableCommand {
     ...
     * @param arguments the arguments: <ul><li>arg[0] = the old name of the Controlled Vocabulary  (String)</li>
     *     <li>arg[1] = the old description of the CV (String)</li> <li>arg[2] = the new name of the Controlled Vocabulary
     *     (String)</li> <li> arg[3] =  the new description of the CV (String)</li>
