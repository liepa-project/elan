...
/**
 * A Command to copy an annotation (i.e. a transferable AnnotationDataRecord) to the System's Clipboard.
 */
public class CopyAnnotationCommand implements Command {
    ...
    public void execute(Object receiver, Object[] arguments) {
        if (arguments[0] instanceof Annotation) {
            AnnotationDataRecord annotationDataRecord = new AnnotationDataRecord((Annotation) arguments[0]);
            TransferableAnnotation ta = new TransferableAnnotation(annotationDataRecord);

            /* HS March 2015, added code to allow citation that includes the media file rather than the transcription
             file */
            ...
            if (copyOption != null) {
                if (copyOption.equals(Constants.CITE_STRING)) {
                    ...
                    if (mediaFile != null) {
                        annotationDataRecord.setFilePath(mediaFile);
                    }
                }
            }
