...
/**
 * An action to delete all annotations on the active tier, left of the crosshair.
 *
 * @author Han Sloetjes
 * @version 1.0
 */
...
public class DeleteAnnotationsLeftOfCA extends CommandAction {
     ...
     *
     * @return array containing the active tier, selection begin time (= 0) and end time (= current media time), or null
     *
