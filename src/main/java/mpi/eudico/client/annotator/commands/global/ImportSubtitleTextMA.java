...
/**
 * A menu action for starting import of subtitle text files (until now only SubRip .srt) or Audacity Label track files.
 */
...
public class ImportSubtitleTextMA extends FrameMenuAction {
     ...
     * @param frame the parent frame of the dialog and the frame to load the file for
     */
    ...
    /**
     * Shows a file selection dialog and starts the import of the selected file.
     *
