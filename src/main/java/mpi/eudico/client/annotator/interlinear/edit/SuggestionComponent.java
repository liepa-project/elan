...
public class SuggestionComponent extends JComponent
	...
	/**
	 * Returns the selected/highlighted fragment.
	 *
	 ...
	 *
	 * @param level the level of incremental selection, this corresponds to the fragment
	...
	/**
	 * Returns the hash of the specified fragment number.
	 *
	...
	/**
	 * Returns the bounds of the specified fragment.
	 *
	 * @param fragNr the fragment index
	...
	/**
	 * Removes the specified listener from the lists of mouse and mouse motion
	 * listeners.
	 *
	 * @param mml the listener
	 */
