...
implements ComponentListener, ActionListener, ACMEditListener {
	...
	/**
	 * Repaints after a change in configuration.
	 */
	...
	/**
	 * Sets the active analyzer configuration.
	 *
	 * @param ac the active configuration
	 */
	...
	/**
	 * Returns the active analyzer configuration.
	 *
	...
	private void initViewer() {
		...
		try {
			configureButton.setIcon(new ImageIcon(this.getClass().getResource(
	...
	/**
	 * Returns a list of names of the visible tiers in the specified row.
	 *
	...
	/**
	 * Returns the data model of the specified row.
	 *
	 * @param row the row index
	...
	/**
	 * Returns the index of the row containing the specified annotation.
	 *
