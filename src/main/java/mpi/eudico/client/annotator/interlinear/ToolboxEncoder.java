...
public class ToolboxEncoder implements AnnotationDocEncoder {
    ...
    public void encodeAndSave(Transcription transcription,
        ...
        if (encoderInfo == null) {
        	LOG.severe("The encoder information object is null, cannot export");
            throw new NullPointerException("The encoder information object is null, cannot export without it");
        }
