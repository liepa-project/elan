...
public class IGTViewerModelImpl implements IGTViewerModel, IGTDataModelListener, TableModel {
	...
	/**
	 * Returns an array of table model listeners.
	 * 
	 * @return array of table model listeners
	 */
    ...
    /**
     * Forwards the event to the registered listeners.
     *  
    ...
    /**
     * Notification that rows have been inserted.
     * 
    ...
    /**
     * Notification that rows have been updated.
     * 
     * @param firstRow the index of the first updated row
     * @param lastRow the index of the last updated row
     */
    ...
    /**
     * Notification that rows have been deleted.
     * 
