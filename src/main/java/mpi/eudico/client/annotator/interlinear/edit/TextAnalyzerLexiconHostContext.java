...
public class TextAnalyzerLexiconHostContext implements
	...
	/**
	 * Creates a new host context instance.
	 *
	 * @param manager the manager object of the interlinearization
	 */
	...
	/**
	 * Returns the {@code Transcription}.
	 *
	...
	/**
	 * Returns a list of names of available lexicons.
	 *
	...
	/**
	 * Returns the {@code LexanLexicon} with the specified name.
	 *
	 * @param lexiconName the name of the lexicon
	 * @return the {@code LexanLexicon} or {@code null} if there is no such lexicon
	 */
	@Override // TextAnalyzerLexiconContext
	...
	/**
	 * Returns the directory where the lexicons are stored.
	 *
