...
//		initComponents();
	...
	/**
	 * Returns the {@code SuggestionComponent} at the specified index.
	 *
	...
	/**
	 * Adds a mouse and mouse motion listener to the lists of listeners.
	 *
	...
	/**
	 * Removes a mouse and mouse motion listener from the lists of listeners.
	 *
	...
	/**
	 * Returns whether the order of suggestions is reversed.
	 *
	...
	/**
	 * Converts the index in the list of visible suggestions to the index in
	 * the model.
	 *
