...
public class IGTTier {
	 ...
	 * @param tierName the name of the tier
	 * @param type the type of tier
	 * @param inWLBlock whether the tier is in a word-level block
	 */
	...
	/**
	 * Returns the list of annotations of this tier.
	 *
	...
	/**
	 * Sets the list of annotations of this tier.
	 *
	...
	/**
	 * Returns the type (the {@code IGTTierType}) of this tier.
	 *
	 * @return the {@code IGTTierType}
	 */
	...
	/**
	 * Sets the type (the {@code IGTTierType}) of this tier.
	 *
    ...
    /**
     * Returns the next annotation for the specified annotation.
     *
    ...
    /**
     * Returns the previous annotation for the specified annotation.
     *
     * @param ann the reference annotation
	...
	/**
	 * Returns the parent tier of this tier.
	 *
	...
	/**
	 * Returns the root tier of this tier.
	 *
