...
public class AnalyzerTypeConfig extends AnalyzerConfig {
	...
	/**
	 * Returns the excluded tier list
	 * @return excluded tiers list
	 */
	...
	/**
	 * Adds tier configuration to the tier confog list
	 * @param ac analyzer configuration
	 */
	...
	/**
	 * Removes tier configuration from the tier config list
	 * @param ac analyzer configuration
