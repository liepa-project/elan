...
public class TextAnalyzerHostContext
	...
	/**
	 * Returns a list of {@code TextAnalyzer}s matching the information and
...
//				}
    ...
    /**
     * Switches the automatic, sequential analyzing mode on or off.
     *
    ...
    /**
     * Returns whether the automatic mode is active.
     *
	...
	/**
	 * Notification of deletion of an annotation. Ignored.
	 *
	...
	/**
	 * Notification of adding of annotations. Ignored.
	 *
	 * @param pos the position of the added annotations
	 */
