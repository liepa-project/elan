...
public class MediaNavPanel extends AbstractEditPrefsPanel implements PreferenceEditor, ChangeListener,
    ...
    private boolean videoAlwaysOnTop = true;
    ...
    private JCheckBox videoFrameAlwaysOnTopCB;
    ...
    private void readPrefs() {
        ...
        boolPref = Preferences.getBool("Media.VideoAlwaysOnTop", null);

        if (boolPref != null) {
            videoAlwaysOnTop = boolPref.booleanValue();
        }
    ...
    private void initComponents() {
        ...
        videoFrameAlwaysOnTopCB = new JCheckBox(ElanLocale.getString(
                "PreferencesDialog.Media.VideoAlwaysOnTop"), videoAlwaysOnTop);

        videoFrameAlwaysOnTopCB.addActionListener(this);
        gbc.gridy = gy++;
        videoFrameAlwaysOnTopCB.setFont(plainFont);
        outerPanel.add(videoFrameAlwaysOnTopCB, gbc);
    ...
    public Map<String, Object> getChangedPreferences() {
        if (isChanged()) {
            ...
            if (videoFrameAlwaysOnTopCB.isSelected() != videoAlwaysOnTop) {
                chMap.put("Media.VideoAlwaysOnTop",
                        Boolean.valueOf(videoFrameAlwaysOnTopCB.isSelected()));
            }
    ...
    public boolean isChanged() {
        ...
        (videoFrameAlwaysOnTopCB.isSelected() != videoAlwaysOnTop) ||
    ...
    public JCheckBox getVideoFrameAlwaysOnTopCB() {
        return videoFrameAlwaysOnTopCB;
    }
