...
public class EditingPanel extends AbstractEditPrefsPanel implements PreferenceEditor, ChangeListener {
    ...
    private JComboBox<String> copyOptionComboBox;
    ...
    private void initComponents() {
        ...
        languageLabel.setFont(deselectCB.getFont());
        cvLanguageBox.setFont(deselectCB.getFont());
	
        copyOptionComboBox = new JComboBox<String>();
        ...
        useCopyCurrentTimeFormatCB.setFont(deselectCB.getFont());
