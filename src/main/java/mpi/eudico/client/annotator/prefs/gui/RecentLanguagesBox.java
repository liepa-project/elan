 ...
 * recently, and fills itself with those. The box can contain {@code String} 
 * and {@code LangInfo} objects.
 * <p>
...
public class RecentLanguagesBox extends JComboBox<Object> {
	/**
	 * Creates a new language box.
	 * 
	...
	public void setSelectedItem(String selectId) {
		...
		boolean selected = false;	
		ComboBoxModel<Object> m = getModel();
