...
public interface AnnotationMatch {
	/**
	 * Abstract method to get the parent context annotation
	 * @return the parent context annotation
	 */
    public Annotation getParentContextAnnotation();
    
    /**
     * Abstract method to get the left context annotation
     * @return the left context annotation
     */
    public Annotation getLeftContextAnnotation();
    
    /**
     * Abstract method to get the right context annotation
     * @return the right context annotation
     */
