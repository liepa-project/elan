...
public class FASTSearchPanel extends AbstractSimpleSearchPanel {
	...
	private static final String LAST_DIR_KEY = "MultipleFileSearchLastDir";
	private static final String PREFERENCES_DIRS_KEY = "MultipleFileSearchDirs";
	private static final String PREFERENCES_PATHS_KEY = "MultipleFileSearchPaths";
	private static final String PREFERENCES_LAST_DOMAIN = "LastUsedMFSearchDomain";
    ...
    private void initComponents() {
    	if (Constants.DARK_MODE) {
    		setBackground(Constants.LIGHTBACKGROUNDCOLOR);
    		searchLogo.setForeground(Constants.DEFAULTFOREGROUNDCOLOR);
    	} else {
