...
public class EAFMultipleFileSearchPanel extends AbstractSimpleSearchPanel {
    ...
    private void setComponents() {
    	if (Constants.DARK_MODE) {
    		...
    		googleLabel.setForeground(Constants.DEFAULTFOREGROUNDCOLOR);
    	} else {
