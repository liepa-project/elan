...
public class StatisticsCollectionMF {
	/** constant for unspecified values */
	public final static String UNSPECIFIED = "unspecified";
	/** the number of columns in tier statistics */
	public static final int NUM_TIER_COL = 9;
	/** the number of columns in type statistics */
	public static final int NUM_TYPE_COL = 10;
	/** the number of columns for participant, annotator and language statistics */
