...
public class MFETierTable extends MFETable {
	...
	/**
	 * Returns the row model of the table.
	 * 
	 ...
	 * @author olasei
	 */
	private static class MyRecentLanguagesEditor extends DefaultCellEditor
...
//        }
	...
	private static class MyRecentLanguagesRenderer extends RecentLanguagesBox implements TableCellRenderer {
