...
//		}
		initComponents();
		WindowLocationAndSizeManager.postInit(this, prefixString, 500, 500);
	}
	
	
	/**
	 * Stores preferences and disposes the dialog
	 */
	...
	/**
	 * Gets the selected Tier names
	 * @return list of selected tier names
	 */
	...
	/**
	 * Gets the list of files from the list of filenames
