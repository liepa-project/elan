...
//		System.out.println("File: " + path);
	...
	protected void initMenuBar() {
        ...
        JCheckBoxMenuItem menuItemAutomaticBackupOn = new JCheckBoxMenuItem(
				new AutoBackupToggleMA(ELANCommandFactory.AUTOMATIC_BACKUP_TOGGLE_ON, this));

        JCheckBoxMenuItem menuItemAutomaticBackupOff = new JCheckBoxMenuItem(
				new AutoBackupToggleMA(ELANCommandFactory.AUTOMATIC_BACKUP_TOGGLE_OFF, this));

		ButtonGroup automaticBackupGroup = new ButtonGroup();
		...
		ElanMenuItem autoBackupSettingsMI = new ElanMenuItem(ma);
...
//        	}
	...
	/**
	 * Initializes menus and commands.
	 */
	@Override
