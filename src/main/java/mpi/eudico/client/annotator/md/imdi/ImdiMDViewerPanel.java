...
//            ((DefaultTreeCellRenderer) tree.getCellRenderer()).setTextSelectionColor(Color.BLACK);
    ...
    private void createPopupMenu() {
        ...
        if (bundle != null) {
            ...
            try {
                tableMI.setText(bundle.getString("MetadataViewer.TableView"));
            } catch (MissingResourceException mre) {
                tableMI.setText("Table View");
            }

            try {
                treeMI.setText(bundle.getString("MetadataViewer.TreeView"));
            } catch (MissingResourceException mre) {
                treeMI.setText("Tree View");
            }
            
            try {
            	hideEmptyMI.setText(bundle.getString("MetadataViewer.HideEmptyValues"));
            } catch (MissingResourceException mre) {
