...
public class TranscriptionModePlayerController implements ChangeListener, ActionListener {
    ...
    public JPanel getSelectionButtonsPanel() {
    	...
    	ImageIcon playSelIcon = new ImageIcon(this.getClass().getResource(
    				Constants.ICON_LOCATION + "PlaySelectionButton.gif"));

    	butPlaySelection = new JButton(playSelIcon);
        ...
        ImageIcon clearSelIcon = new ImageIcon(this.getClass().getResource(
        			Constants.ICON_LOCATION + "ClearSelectionButton.gif"));	

        butClearSelection = new JButton(clearSelIcon);
    ...
    /**
     * Updates localized user interface components after a change in interface
     * language.
     */
