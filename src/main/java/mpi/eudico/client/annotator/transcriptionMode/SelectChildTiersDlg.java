...
//    	 setDefaultCloseOperation(WindowConstants.DO_NOTHING_ON_CLOSE);
    ...
    /**
     * Returns whether anything was changed in the dialog.
     * 
    ...
    /**
     * Returns a map with single tiers as the key and lists of linked or 
     * matched tiers as the values.
     * 
     * @return a map with tier to matched tiers combinations
     */
	...
	/**
	 * Returns a list of tiers that are hidden, have been set to invisible.
	 * 
	...
	/**
	 * Returns a list of types (type names) per column.
	 * 
