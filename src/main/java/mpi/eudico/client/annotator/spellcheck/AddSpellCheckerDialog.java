...
public class AddSpellCheckerDialog extends ClosableDialog implements ActionListener, ItemListener {
	...
	private JComboBox<SpellCheckerType> checkerTypeBox;
	private JComboBox<Object> newLanguageComboBox;	// contains all available languages
	...
	private void initComponents() {
		...
		checkerTypeBox = new JComboBox<SpellCheckerType>();
	...
	private JPanel createPanelForType(SpellCheckerType type) {
		...
		for(Pair<String, String> field : fields) {
			...
			if (type == SpellCheckerType.GECCO) {
				textField.setText(GeccoClient.fullURL);//  initialize the URL field
				newLanguageComboBox.setSelectedItem(LanguageCollection.getLanguageInfo("nld"));
			}
...
//	    setSize(700,260);
	 ...
	 */
	protected JComboBox<Object> getNewLanguageComboBox() {
	...
	protected void updateNewLanguageComboBox() {
		if(!(newLanguageComboBox instanceof RecentLanguagesBox)) {
			...
			ComboBoxModel<Object> m = new LanguagesListModel(languages);
	...
	int getNumberOfLanguages() {
		...
		} else if (newLanguageComboBox != null) {
			return newLanguageComboBox.getItemCount();
		}
		return 0;
	}
	 ...
	 * @author olasei
	 */
	private static class LanguagesListModel extends AbstractListModel<Object>
