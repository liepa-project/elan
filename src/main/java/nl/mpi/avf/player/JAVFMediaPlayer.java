...
/*######### Wrapper getters for getter methods in JAVFPlayer ########*/
	...
	/**
	 * Retrieves a number of frames from the video.
	 * 
	 *  @param sampleTimeBegin the media time of the first sample of the 
	 *  sequence, in milliseconds
	 *  @param sampleTimeEnd the media time of the last sample of the sequence,
	 *  in milliseconds
	 *  @param buffer the {@code ByteBuffer} to copy the images' bytes into
	 *  
	 *  @return an array of time values corresponding to the frames loaded into
	 *  the buffer
	 */
	...
	/**
	 * Returns the current {@code [x,y,w,h]} values of the video image.
	 * 
