...
public class TimedImageSequence implements Comparable<TimedImageSequence> {
	...
	/**
	 * Constructor creates a list based on the specified times and images.
	 * 
...
//		}
	...
	/**
	 * Returns the first media time in the list.
	 * 
	...
	/**
	 * Returns whether a specified time is in the current list.
	 * 
...
//		}
	...
	/**
	 * Returns the image for the specified time.
	 * 
...
//		}
	...
	/**
	 * Returns the timed image for the specified time.
	 * 
...
//		}
	...
	/**
	 * Returns the index of the image corresponding to the time.
	 * 
	...
	/**
	 * Sets the sequence of timed images.
	 * 
	...
	public int compareTo(TimedImageSequence otherSeq) {
		...
		if (this.timeImaList != null && !this.timeImaList.isEmpty()) {
			...
			if (Double.compare(timeImaList.get(0).t, d) < 0) {
				return -1;
			} 
			//if (timeImaList.get(0).t > d) {
			if (Double.compare(timeImaList.get(0).t, d) > 0) {
