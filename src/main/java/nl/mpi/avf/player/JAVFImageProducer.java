...
public class JAVFImageProducer {
	...
	/**
	 * An enumeration of AV Foundation image settings.
	 */
	public enum IMAGE_PRESETS {
		/** 24 bits RGB using {@code int} buffer */
		AV_24RGB_DATABUFFER_INT,
		/** 24 bits RGB using {@code byte} buffer */
		AV_24RGB_DATABUFFER_BYTE,
		/** 32 bits BGRA using {@code int} buffer */
		AV_32BGRA_DATABUFFER_INT,
		/** 32 bits BGRA using {@code byte} buffer */
		AV_32BGRA_DATABUFFER_BYTE,
		/** 32 bits ARGB using {@code int} buffer */
		AV_32ARGB_DATABUFFER_INT,
		/** 32 bits ARGB using {@code byte} buffer */
