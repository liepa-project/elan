...
public class JAVFVisualComponent extends JPanel implements ComponentListener, JAVFComponent {
	/** natural video dimension */
	private Dimension naturalVideoSize;
	/**
	 * a transform object to scale from encoded image pixels to encoded 
	 * 'natural' video width and height
	 */
	private AffineTransform pixelsToVideoSizeTransform = null;
	/** flag for first transform check */
	private boolean pixelToImageTransformChecked = false;
	/** flag for background painting */
	...
	private static final double MS_SEC = 1000d;
	/** custom aspect ratio */
	private float forcedAspectRatio = -1;
	/**
	 * transform object for scaling to the component size
	 */
