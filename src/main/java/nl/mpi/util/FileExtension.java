...
public class FileExtension {
    ...
    /** Known extensions for the Elan Backup Files */
    public static final String[] BACKUP_EXT = new String[] {"001", "002", "003", "004", "005"};
	...
	/** Known extension for WebVTT subtitle files */
    public static final String[] WEBVTT_EXT = new String[] { "vtt" };
