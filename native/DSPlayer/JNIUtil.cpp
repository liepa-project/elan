...
char * JNIUtil::jstringToCharArray(JNIEnv *env, jstring str){
	jbyteArray bytes = 0;
	jthrowable exc;
	char *result = 0;
...
wchar_t * JNIUtil::convert(JNIEnv * env, jstring s) {
...
jchar * JNIUtil::convertToJchar(JNIEnv *env, wchar_t *in, size_t *length) {
